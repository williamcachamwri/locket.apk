...
public final class ULongSerializer implements KSerializer<ULong> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return ULong.m2612boximpl(m1899deserializeI7RO_PI(decoder));
    }

    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m1900serialize2TYgG_w(encoder, ((ULong) obj).m2670unboximpl());
    }
    ...
    public void m1900serialize2TYgG_w(Encoder encoder, long j) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeInline(getDescriptor()).encodeLong(j);
    }

    /* renamed from: deserialize-I7RO_PI  reason: not valid java name */
    public long m1899deserializeI7RO_PI(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return ULong.m2618constructorimpl(decoder.decodeInline(getDescriptor()).decodeLong());
    }
}
