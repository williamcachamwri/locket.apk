...
public final class UShortArraySerializer extends PrimitiveArraySerializer<UShort, UShortArray, UShortArrayBuilder> implements KSerializer<UShortArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m1903collectionSizerL5Bavg(((UShortArray) obj).m2792unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return UShortArray.m2776boximpl(m1904emptyamswpOA());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m1905toBuilderrL5Bavg(((UShortArray) obj).m2792unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, Object obj, int i) {
        m1906writeContenteny0XGE(compositeEncoder, ((UShortArray) obj).m2792unboximpl(), i);
    }
    ...
    public int m1903collectionSizerL5Bavg(short[] sArr) {
        Intrinsics.checkNotNullParameter(sArr, "$this$collectionSize");
        return UShortArray.m2784getSizeimpl(sArr);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder-rL5Bavg  reason: not valid java name */
    public UShortArrayBuilder m1905toBuilderrL5Bavg(short[] sArr) {
    ...
    public short[] m1904emptyamswpOA() {
        return UShortArray.m2777constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder compositeDecoder, int i, UShortArrayBuilder uShortArrayBuilder, boolean z) {
        ...
        uShortArrayBuilder.m1901appendxj2QHRw$kotlinx_serialization_core(UShort.m2725constructorimpl(compositeDecoder.decodeInlineElement(getDescriptor(), i).decodeShort()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-eny0XGE  reason: not valid java name */
    public void m1906writeContenteny0XGE(CompositeEncoder compositeEncoder, short[] sArr, int i) {
        Intrinsics.checkNotNullParameter(compositeEncoder, "encoder");
        Intrinsics.checkNotNullParameter(sArr, "content");
        for (int i2 = 0; i2 < i; i2++) {
            compositeEncoder.encodeInlineElement(getDescriptor(), i2).encodeShort(UShortArray.m2783getMh2AYeg(sArr, i2));
        }
    }
}
