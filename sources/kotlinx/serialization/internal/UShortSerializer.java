...
public final class UShortSerializer implements KSerializer<UShort> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return UShort.m2719boximpl(m1907deserializeBwKQO78(decoder));
    }

    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m1908serializei8woANY(encoder, ((UShort) obj).m2775unboximpl());
    }
    ...
    public void m1908serializei8woANY(Encoder encoder, short s) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeInline(getDescriptor()).encodeShort(s);
    }

    /* renamed from: deserialize-BwKQO78  reason: not valid java name */
    public short m1907deserializeBwKQO78(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return UShort.m2725constructorimpl(decoder.decodeInline(getDescriptor()).decodeShort());
    }
}
