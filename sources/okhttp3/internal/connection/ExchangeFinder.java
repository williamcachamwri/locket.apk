...
public final class ExchangeFinder {
    ...
    public ExchangeFinder(RealConnectionPool realConnectionPool, Address address2, RealCall realCall, EventListener eventListener2) {
        ...
        Intrinsics.checkNotNullParameter(address2, SentryLockReason.JsonKeys.ADDRESS);
    ...
    private final okhttp3.internal.connection.RealConnection findConnection(int r15, int r16, int r17, int r18, boolean r19) throws java.io.IOException {
        /*
            ...
            monitor-enter(r2)
            boolean r5 = r2.getNoNewExchanges()     // Catch:{ all -> 0x0065 }
            if (r5 != 0) goto L_0x0030
            okhttp3.Route r5 = r2.route()     // Catch:{ all -> 0x0065 }
            okhttp3.Address r5 = r5.address()     // Catch:{ all -> 0x0065 }
            okhttp3.HttpUrl r5 = r5.url()     // Catch:{ all -> 0x0065 }
            boolean r5 = r14.sameHostAndPort(r5)     // Catch:{ all -> 0x0065 }
        ...
        L_0x002e:
            ...
            goto L_0x0036
        L_0x0030:
            okhttp3.internal.connection.RealCall r5 = r1.call     // Catch:{ all -> 0x0065 }
            java.net.Socket r5 = r5.releaseConnectionNoEvents$okhttp()     // Catch:{ all -> 0x0065 }
        L_0x0036:
            kotlin.Unit r6 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0065 }
            monitor-exit(r2)
        ...
        L_0x0107:
            ...
            okhttp3.internal.connection.RealCall r6 = r1.call     // Catch:{ all -> 0x0186 }
            r12 = r6
            okhttp3.Call r12 = (okhttp3.Call) r12     // Catch:{ all -> 0x0186 }
            okhttp3.EventListener r13 = r1.eventListener     // Catch:{ all -> 0x0186 }
            r6 = r3
            r7 = r15
            r8 = r16
            r9 = r17
            r10 = r18
            r11 = r19
            r6.connect(r7, r8, r9, r10, r11, r12, r13)     // Catch:{ all -> 0x0186 }
            okhttp3.internal.connection.RealCall r6 = r1.call
        ...
        L_0x0168:
            monitor-enter(r3)
            okhttp3.internal.connection.RealConnectionPool r0 = r1.connectionPool     // Catch:{ all -> 0x0183 }
            r0.put(r3)     // Catch:{ all -> 0x0183 }
            okhttp3.internal.connection.RealCall r0 = r1.call     // Catch:{ all -> 0x0183 }
            r0.acquireConnectionNoEvents(r3)     // Catch:{ all -> 0x0183 }
            kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0183 }
            monitor-exit(r3)
