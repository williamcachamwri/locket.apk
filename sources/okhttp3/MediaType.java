...
public final class MediaType {
    ...
    public final String m1989deprecated_type() {
        return this.type;
    }
    ...
    public final String m1988deprecated_subtype() {
        return this.subtype;
    }
    ...
    public static final class Companion {
        ...
        public final MediaType m1990deprecated_get(String str) {
        ...
        public final MediaType m1991deprecated_parse(String str) {
            Intrinsics.checkNotNullParameter(str, "mediaType");
            return parse(str);
        }
    }
