...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final java.io.File copyTo(java.io.File r6, java.io.File r7, boolean r8, int r9) {
        ...
        L_0x004d:
            ...
            r8.<init>(r6)
            java.io.FileInputStream r6 = io.sentry.instrumentation.file.SentryFileInputStream.Factory.create((java.io.FileInputStream) r8, (java.io.File) r6)
            java.io.Closeable r6 = (java.io.Closeable) r6
            r8 = r6
            java.io.FileInputStream r8 = (java.io.FileInputStream) r8     // Catch:{ all -> 0x007f }
            java.io.FileOutputStream r0 = new java.io.FileOutputStream     // Catch:{ all -> 0x007f }
            r0.<init>(r7)     // Catch:{ all -> 0x007f }
            java.io.FileOutputStream r0 = io.sentry.instrumentation.file.SentryFileOutputStream.Factory.create((java.io.FileOutputStream) r0, (java.io.File) r7)     // Catch:{ all -> 0x007f }
            java.io.Closeable r0 = (java.io.Closeable) r0     // Catch:{ all -> 0x007f }
            r1 = r0
            java.io.FileOutputStream r1 = (java.io.FileOutputStream) r1     // Catch:{ all -> 0x0078 }
            java.io.InputStream r8 = (java.io.InputStream) r8     // Catch:{ all -> 0x0078 }
            java.io.OutputStream r1 = (java.io.OutputStream) r1     // Catch:{ all -> 0x0078 }
            kotlin.io.ByteStreamsKt.copyTo(r8, r1, r9)     // Catch:{ all -> 0x0078 }
            r8 = 0
            kotlin.io.CloseableKt.closeFinally(r0, r8)     // Catch:{ all -> 0x007f }
        ...
        L_0x007a:
            r8 = move-exception
            kotlin.io.CloseableKt.closeFinally(r0, r7)     // Catch:{ all -> 0x007f }
