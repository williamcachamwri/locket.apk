...
public final class ClassReference implements KClass<Object>, ClassBasedDeclarationContainer {
    ...
    static {
        ...
        for (String str : values) {
            ...
            Pair pair = TuplesKt.to(sb.append(StringsKt.substringAfterLast$default(str, (char) FilenameUtils.EXTENSION_SEPARATOR, (String) null, 2, (Object) null)).append("CompanionObject").toString(), str + ".Companion");
        ...
        for (Map.Entry entry : map2.entrySet()) {
            linkedHashMap.put(entry.getKey(), StringsKt.substringAfterLast$default((String) entry.getValue(), (char) FilenameUtils.EXTENSION_SEPARATOR, (String) null, 2, (Object) null));
        }
