...
public final class UStringsKt {
    ...
    public static final String m1571toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m1573toStringolVBNx4(short s, int i) {
    ...
    public static final String m1572toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(((long) i) & MuxerUtil.UNSIGNED_INT_MAX_VALUE, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40  reason: not valid java name */
    public static final String m1570toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m2512unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m2775unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m2591unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m2670unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m2591unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m2539constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m2456boximpl(UByte.m2462constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m2591unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m2539constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m2719boximpl(UShort.m2725constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m2539constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m2539constructorimpl(i3 * r3);
            int r7 = UInt.m2539constructorimpl(UInt.m2539constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m2618constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m2618constructorimpl(j * r5);
            long r13 = ULong.m2618constructorimpl(ULong.m2618constructorimpl(((long) UInt.m2539constructorimpl(digitOf)) & MuxerUtil.UNSIGNED_INT_MAX_VALUE) + r9);
