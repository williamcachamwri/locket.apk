...
public final class UIntArrayKt {
    ...
    private static final int[] m2610uintArrayOfajY9A(int... iArr) {
    ...
    private static final int[] UIntArray(int i, Function1<? super Integer, UInt> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            iArr[i2] = function1.invoke(Integer.valueOf(i2)).m2591unboximpl();
        }
        return UIntArray.m2594constructorimpl(iArr);
    }
}
