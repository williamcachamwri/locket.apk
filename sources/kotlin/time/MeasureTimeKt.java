...
public final class MeasureTimeKt {
    public static final long measureTime(Function0<Unit> function0) {
        ...
        long r0 = TimeSource.Monotonic.INSTANCE.m1740markNowz9LOYto();
        function0.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1745elapsedNowUwyO8pc(r0);
    }
    ...
    public static final long measureTime(TimeSource timeSource, Function0<Unit> function0) {
        ...
        function0.invoke();
        return markNow.m1735elapsedNowUwyO8pc();
    }
    ...
    public static final long measureTime(TimeSource.Monotonic monotonic, Function0<Unit> function0) {
        ...
        Intrinsics.checkNotNullParameter(function0, "block");
        long r0 = monotonic.m1740markNowz9LOYto();
        function0.invoke();
        return TimeSource.Monotonic.ValueTimeMark.m1745elapsedNowUwyO8pc(r0);
    }
    ...
    public static final <T> TimedValue<T> measureTimedValue(Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(function0, "block");
        return new TimedValue<>(function0.invoke(), TimeSource.Monotonic.ValueTimeMark.m1745elapsedNowUwyO8pc(TimeSource.Monotonic.INSTANCE.m1740markNowz9LOYto()), (DefaultConstructorMarker) null);
    }

    public static final <T> TimedValue<T> measureTimedValue(TimeSource timeSource, Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(timeSource, "<this>");
        Intrinsics.checkNotNullParameter(function0, "block");
        return new TimedValue<>(function0.invoke(), timeSource.markNow().m1735elapsedNowUwyO8pc(), (DefaultConstructorMarker) null);
    }

    public static final <T> TimedValue<T> measureTimedValue(TimeSource.Monotonic monotonic, Function0<? extends T> function0) {
        Intrinsics.checkNotNullParameter(monotonic, "<this>");
        Intrinsics.checkNotNullParameter(function0, "block");
        return new TimedValue<>(function0.invoke(), TimeSource.Monotonic.ValueTimeMark.m1745elapsedNowUwyO8pc(monotonic.m1740markNowz9LOYto()), (DefaultConstructorMarker) null);
    }
}
