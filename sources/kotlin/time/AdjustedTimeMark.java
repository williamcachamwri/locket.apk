...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark m1588minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m1738minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m1586elapsedNowUwyO8pc() {
        return Duration.m1633minusLRDsOJo(this.mark.m1735elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m1589plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m1634plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
