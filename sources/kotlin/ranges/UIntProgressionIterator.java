...
final class UIntProgressionIterator implements Iterator<UInt>, KMappedMarker {
    ...
    private UIntProgressionIterator(int i, int i2, int i3) {
        ...
        this.hasNext = z;
        this.step = UInt.m2539constructorimpl(i3);
        this.next = !this.hasNext ? i2 : i;
    }

    public /* bridge */ /* synthetic */ Object next() {
        return UInt.m2533boximpl(m3667nextpVg5ArA());
    }
    ...
    public int m3667nextpVg5ArA() {
        int i = this.next;
        if (i != this.finalElement) {
            this.next = UInt.m2539constructorimpl(this.step + i);
