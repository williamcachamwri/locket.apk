...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        if (i3 == 0) {
            ...
            this.first = i;
            this.last = UProgressionUtilKt.m3650getProgressionLastElementNkh28Cs(i, i2, i3);
            this.step = i3;
        } else {
    ...
    public final int m3664getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m3665getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        StringBuilder sb;
        if (this.step > 0) {
            sb = new StringBuilder().append(UInt.m2585toStringimpl(this.first)).append("..").append(UInt.m2585toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            sb = new StringBuilder().append(UInt.m2585toStringimpl(this.first)).append(" downTo ").append(UInt.m2585toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m3666fromClosedRangeNkh28Cs(int i, int i2, int i3) {
