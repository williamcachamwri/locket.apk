...
public final class UShortArrayKt {
    ...
    private static final short[] m2794ushortArrayOfrL5Bavg(short... sArr) {
    ...
    private static final short[] UShortArray(int i, Function1<? super Integer, UShort> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            sArr[i2] = function1.invoke(Integer.valueOf(i2)).m2775unboximpl();
        }
        return UShortArray.m2778constructorimpl(sArr);
    }
}
