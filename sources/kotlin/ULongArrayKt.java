...
public final class ULongArrayKt {
    ...
    private static final long[] m2689ulongArrayOfQwZRm1k(long... jArr) {
    ...
    private static final long[] ULongArray(int i, Function1<? super Integer, ULong> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            jArr[i2] = function1.invoke(Integer.valueOf(i2)).m2670unboximpl();
        }
        return ULongArray.m2673constructorimpl(jArr);
    }
}
