...
public final class ReflectClassUtilKt {
    ...
    public static final String getDesc(Class<?> cls) {
        ...
        if (cls.isPrimitive()) {
            ...
            return StringsKt.replace$default(name2, (char) FilenameUtils.EXTENSION_SEPARATOR, (char) IOUtils.DIR_SEPARATOR_UNIX, false, 4, (Object) null);
        } else {
            StringBuilder sb = new StringBuilder("L");
            String name3 = cls.getName();
            Intrinsics.checkNotNullExpressionValue(name3, "getName(...)");
            return sb.append(StringsKt.replace$default(name3, (char) FilenameUtils.EXTENSION_SEPARATOR, (char) IOUtils.DIR_SEPARATOR_UNIX, false, 4, (Object) null)).append(';').toString();
        }
    }
