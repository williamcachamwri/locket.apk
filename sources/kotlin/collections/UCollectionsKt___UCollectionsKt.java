...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m2514constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m2525setVurrAj0(r0, i, r2.m2512unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m2593constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m2604setVXSXFK8(r0, i, r2.m2591unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m2672constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m2683setk8EXiF4(r0, i, r2.m2670unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m2777constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m2788set01HTLdE(r0, i, r2.m2775unboximpl());
            i++;
        }
        return r0;
    }
