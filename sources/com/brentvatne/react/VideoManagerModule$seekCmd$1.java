...
final class VideoManagerModule$seekCmd$1 extends Lambda implements Function1<ReactExoplayerView, Unit> {
    final /* synthetic */ float $time;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoManagerModule$seekCmd$1(float f) {
        super(1);
        this.$time = f;
    }
    ...
    public final void invoke(ReactExoplayerView reactExoplayerView) {
        if (reactExoplayerView != null) {
            reactExoplayerView.seekTo((long) MathKt.roundToInt(this.$time * 1000.0f));
        }
    }
}
