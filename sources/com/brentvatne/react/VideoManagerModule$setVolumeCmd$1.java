...
final class VideoManagerModule$setVolumeCmd$1 extends Lambda implements Function1<ReactExoplayerView, Unit> {
    final /* synthetic */ float $volume;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoManagerModule$setVolumeCmd$1(float f) {
        super(1);
        this.$volume = f;
    }
    ...
    public final void invoke(ReactExoplayerView reactExoplayerView) {
        if (reactExoplayerView != null) {
            reactExoplayerView.setVolumeModifier(this.$volume);
        }
    }
}
