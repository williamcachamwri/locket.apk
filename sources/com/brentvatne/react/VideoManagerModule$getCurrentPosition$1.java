...
final class VideoManagerModule$getCurrentPosition$1 extends Lambda implements Function1<ReactExoplayerView, Unit> {
    final /* synthetic */ Promise $promise;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    VideoManagerModule$getCurrentPosition$1(Promise promise) {
        super(1);
    ...
    public final void invoke(ReactExoplayerView reactExoplayerView) {
        if (reactExoplayerView != null) {
            reactExoplayerView.getCurrentPosition(this.$promise);
        }
    }
}
