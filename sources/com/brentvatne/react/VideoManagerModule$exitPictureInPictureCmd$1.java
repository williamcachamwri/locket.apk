...
final class VideoManagerModule$exitPictureInPictureCmd$1 extends Lambda implements Function1<ReactExoplayerView, Unit> {
    public static final VideoManagerModule$exitPictureInPictureCmd$1 INSTANCE = new VideoManagerModule$exitPictureInPictureCmd$1();

    VideoManagerModule$exitPictureInPictureCmd$1() {
        super(1);
    }
