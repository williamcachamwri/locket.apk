...
public final class Expand$$serializer implements GeneratedSerializer<Expand> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("expand", expand$$serializer, 1);
    ...
    public Expand deserialize(Decoder decoder) {
        String str;
        ...
        return new Expand(i, str, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, Expand expand) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(expand, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        Expand.write$Self$static_release(expand, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
