...
public final class Position$$serializer implements GeneratedSerializer<Position> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.adsbynimbus.render.mraid.Position", position$$serializer, 4);
        pluginGeneratedSerialDescriptor.addElement("width", false);
        pluginGeneratedSerialDescriptor.addElement("height", false);
        pluginGeneratedSerialDescriptor.addElement(ViewHierarchyNode.JsonKeys.X, false);
        pluginGeneratedSerialDescriptor.addElement(ViewHierarchyNode.JsonKeys.Y, false);
    ...
    public Position deserialize(Decoder decoder) {
        ...
        return new Position(i5, i4, i3, i2, i, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, Position position) {
        ...
        Position.write$Self$static_release(position, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
