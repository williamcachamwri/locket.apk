...
public final class ExpandProperties$$serializer implements GeneratedSerializer<ExpandProperties> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{IntSerializer.INSTANCE, IntSerializer.INSTANCE, BooleanSerializer.INSTANCE, BooleanSerializer.INSTANCE};
    }

    public ExpandProperties deserialize(Decoder decoder) {
        boolean z;
        boolean z2;
        int i;
        int i2;
        ...
        return new ExpandProperties(i3, i2, i, z2, z, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, ExpandProperties expandProperties) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        Intrinsics.checkNotNullParameter(expandProperties, "value");
        SerialDescriptor descriptor2 = getDescriptor();
        CompositeEncoder beginStructure = encoder.beginStructure(descriptor2);
        ExpandProperties.write$Self$static_release(expandProperties, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
