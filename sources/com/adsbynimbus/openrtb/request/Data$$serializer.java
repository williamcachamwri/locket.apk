...
public final class Data$$serializer implements GeneratedSerializer<Data> {
    ...
    static {
        ...
        PluginGeneratedSerialDescriptor pluginGeneratedSerialDescriptor = new PluginGeneratedSerialDescriptor("com.adsbynimbus.openrtb.request.Data", data$$serializer, 3);
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(StringSerializer.INSTANCE), BuiltinSerializersKt.getNullable(Data.$childSerializers[2])};
    }
    ...
    public Data deserialize(Decoder decoder) {
        ...
        KSerializer[] access$get$childSerializers$cp = Data.$childSerializers;
        String str3 = null;
        if (beginStructure.decodeSequentially()) {
            set = (Set) beginStructure.decodeNullableSerializableElement(descriptor2, 2, access$get$childSerializers$cp[2], null);
            ...
            while (z) {
                ...
                if (decodeElementIndex == -1) {
                    ...
                    set2 = (Set) beginStructure.decodeNullableSerializableElement(descriptor2, 2, access$get$childSerializers$cp[2], set2);
                    i2 |= 4;
                } else {
        ...
        return new Data(i, str2, str, set, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, Data data) {
        ...
        Data.write$Self$kotlin_release(data, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
