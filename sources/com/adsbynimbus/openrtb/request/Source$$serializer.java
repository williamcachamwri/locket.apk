...
public final class Source$$serializer implements GeneratedSerializer<Source> {
    ...
    public KSerializer<?>[] childSerializers() {
        return new KSerializer[]{Source.$childSerializers[0]};
    }
    ...
    public Source deserialize(Decoder decoder) {
        ...
        KSerializer[] access$get$childSerializers$cp = Source.$childSerializers;
        int i = 1;
        ...
        return new Source(i, map, (SerializationConstructorMarker) null);
    }
    ...
    public void serialize(Encoder encoder, Source source) {
        ...
        Source.write$Self$kotlin_release(source, beginStructure, descriptor2);
        beginStructure.endStructure(descriptor2);
    }
