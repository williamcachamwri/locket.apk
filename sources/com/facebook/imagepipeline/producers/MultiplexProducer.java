...
public abstract class MultiplexProducer<K, T extends Closeable> implements Producer<T> {
    ...
    class Multiplexer {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:21:0x0072, code lost:
            ((com.facebook.imagepipeline.producers.ProducerContext) r2.second).putExtra(com.facebook.imagepipeline.producers.MultiplexProducer.access$1000(r6.this$0), java.lang.Integer.valueOf(r1));
         */
        ...
        public void onNextResult(com.facebook.imagepipeline.producers.MultiplexProducer<K, T>.Multiplexer.ForwardingConsumer r7, @javax.annotation.Nullable T r8, int r9) {
            ...
            L_0x0072:
                ...
                r3.putExtra(r4, r5)     // Catch:{ all -> 0x008c }
            L_0x0083:
