            ...
            if (childAt instanceof ReactRawTextShadowNode) {
                ...
                if (childAt instanceof ReactBaseTextShadowNode) {
                    ...
                    if (reactShadowNodeImpl instanceof ReactTextInlineImageShadowNode) {
                        ...
                        list2.add(new SetSpanOperation(spannableStringBuilder.length() - 1, spannableStringBuilder.length(), ((ReactTextInlineImageShadowNode) reactShadowNodeImpl).buildInlineImageSpan()));
                    } else if (z) {
                        ...
                        if (styleWidth.unit == YogaUnit.POINT && styleHeight.unit == YogaUnit.POINT) {
                            ...
                            f2 = reactShadowNodeImpl.getLayoutWidth();
                            f = reactShadowNodeImpl.getLayoutHeight();
                        }
                        spannableStringBuilder2.append(INLINE_VIEW_PLACEHOLDER);
