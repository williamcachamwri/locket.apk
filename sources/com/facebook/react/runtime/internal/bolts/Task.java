...
public class Task<TResult> implements TaskInterface<TResult> {
    ...
    public boolean trySetError(java.lang.Exception r4) {
        ...
        L_0x000a:
            ...
            com.facebook.react.runtime.internal.bolts.Task$UnobservedExceptionHandler r4 = getUnobservedExceptionHandler()     // Catch:{ all -> 0x002c }
            if (r4 == 0) goto L_0x002a
            com.facebook.react.runtime.internal.bolts.UnobservedErrorNotifier r4 = new com.facebook.react.runtime.internal.bolts.UnobservedErrorNotifier     // Catch:{ all -> 0x002c }
