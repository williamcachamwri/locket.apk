...
final class CameraViewModule$stopRecording$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    CameraViewModule$stopRecording$1(CameraViewModule cameraViewModule, int i, Promise promise, Continuation<? super CameraViewModule$stopRecording$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CameraViewModule$stopRecording$1(this.this$0, this.$viewTag, this.$promise, continuation);
    }

    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((CameraViewModule$stopRecording$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
