...
public final class NoCameraDeviceError extends CameraError {
    public NoCameraDeviceError() {
        super(Device.TYPE, "no-device", "No device was set! Use `useCameraDevice(..)` or `Camera.getAvailableCameraDevices()` to select a suitable Camera device.", (Throwable) null, 8, (DefaultConstructorMarker) null);
    }
}
