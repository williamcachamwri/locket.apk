...
final class CameraSession_ConfigurationKt$configureOutputs$preview$1$1 extends Lambda implements Function1<CameraDeviceFormat, Boolean> {
    final /* synthetic */ CameraConfiguration $configuration;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CameraSession_ConfigurationKt$configureOutputs$preview$1$1(CameraConfiguration cameraConfiguration) {
        super(1);
