...
final class CameraSession_ConfigurationKt$configureOutputs$preview$1$2 extends Lambda implements Function1<CameraDeviceFormat, Boolean> {
    final /* synthetic */ Range<Integer> $fpsRange;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CameraSession_ConfigurationKt$configureOutputs$preview$1$2(Range<Integer> range) {
        super(1);
        this.$fpsRange = range;
    }
