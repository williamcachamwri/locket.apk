...
public final class NoOutputsError extends CameraError {
    public NoOutputsError() {
        super(EnvelopeCache.PREFIX_CURRENT_SESSION_FILE, "no-outputs", "Cannot create a CameraCaptureSession without any outputs! (PREVIEW, PHOTO, VIDEO, ...)", (Throwable) null, 8, (DefaultConstructorMarker) null);
    }
}
