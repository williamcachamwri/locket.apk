...
public final class SimpleTimeLimiter implements TimeLimiter {
    ...
    public <T> T newProxy(T t, Class<T> cls, long j, TimeUnit timeUnit) {
        ...
        return newProxy(cls, new InvocationHandler(this) {
            ...
            public Object invoke(Object obj, Method method, @CheckForNull Object[] objArr) throws Throwable {
                return this.this$0.callWithTimeout(new SimpleTimeLimiter$1$$ExternalSyntheticLambda0(method, t2, objArr), j2, timeUnit2, findInterruptibleMethods.contains(method));
            }
