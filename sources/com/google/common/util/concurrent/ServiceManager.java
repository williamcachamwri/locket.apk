...
public final class ServiceManager implements ServiceManagerBridge {
    ...
    public ServiceManager startAsync() {
        ...
        while (it2.hasNext()) {
            ...
            try {
                ...
                logger.get().log(Level.WARNING, "Unable to start Service " + next, e);
            }
        }
        return this;
    }
    ...
    private static final class ServiceListener extends Service.Listener {
        ...
        public void terminated(Service.State state2) {
            ...
            if (serviceManagerState != null) {
                if (!(this.service instanceof NoOpService)) {
                    ServiceManager.logger.get().log(Level.FINE, "Service {0} has terminated. Previous state was: {1}", new Object[]{this.service, state2});
                }
        ...
        public void failed(Service.State state2, Throwable th) {
            ...
            if (serviceManagerState != null) {
                ...
                if (z2 && z) {
                    ServiceManager.logger.get().log(Level.SEVERE, "Service " + this.service + " has failed in the " + state2 + " state.", th);
                }
