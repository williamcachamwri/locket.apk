...
public abstract class Striped<L> {
    ...
    public static Striped<Lock> lazyWeakLock(int i) {
        return lazyWeakCustom(i, new Striped$$ExternalSyntheticLambda4());
    }
    ...
    public static Striped<Semaphore> lazyWeakSemaphore(int i, int i2) {
        return lazyWeakCustom(i, new Striped$$ExternalSyntheticLambda1(i2));
    }
    ...
    public static Striped<ReadWriteLock> lazyWeakReadWriteLock(int i) {
        return lazyWeakCustom(i, new Striped$$ExternalSyntheticLambda2());
    }
