...
public class ImmutableRangeMap<K extends Comparable<?>, V> implements RangeMap<K, V>, Serializable {
    ...
    @CheckForNull
    public V get(K k) {
        int binarySearch = SortedLists.binarySearch(this.ranges, new ImmutableRangeMap$$ExternalSyntheticLambda0(), Cut.belowValue(k), SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_LOWER);
    ...
    public ImmutableRangeMap<K, V> subRangeMap(final Range<K> range) {
        ...
        final int binarySearch = SortedLists.binarySearch(this.ranges, new ImmutableRangeMap$$ExternalSyntheticLambda1(), range.lowerBound, SortedLists.KeyPresentBehavior.FIRST_AFTER, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
        int binarySearch2 = SortedLists.binarySearch(this.ranges, new ImmutableRangeMap$$ExternalSyntheticLambda0(), range.upperBound, SortedLists.KeyPresentBehavior.ANY_PRESENT, SortedLists.KeyAbsentBehavior.NEXT_HIGHER);
        if (binarySearch >= binarySearch2) {
            return of();
        }
        final int i = binarySearch2 - binarySearch;
        final Range<K> range2 = range;
        return new ImmutableRangeMap<K, V>(this, new ImmutableList<Range<K>>(this) {
            ...
            public Range<K> get(int i) {
                ...
                if (i == 0 || i == i - 1) {
                    return ((Range) this.this$0.ranges.get(i + binarySearch)).intersection(range);
                }
                return (Range) this.this$0.ranges.get(i + binarySearch);
            }
            ...
            /* access modifiers changed from: package-private */
            public Object writeReplace() {
                return ImmutableRangeMap.super.writeReplace();
            }
        };
    }
