...
public final class Multimaps {
    ...
    private static class CustomMultimap<K, V> extends AbstractMapBasedMultimap<K, V> {
        ...
        private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
            ...
            this.factory = (com.google.common.base.Supplier) Objects.requireNonNull(objectInputStream.readObject());
    ...
    private static class CustomSortedSetMultimap<K, V> extends AbstractSortedSetMultimap<K, V> {
        ...
        private void readObject(ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
            objectInputStream.defaultReadObject();
            com.google.common.base.Supplier<? extends SortedSet<V>> supplier = (com.google.common.base.Supplier) Objects.requireNonNull(objectInputStream.readObject());
    ...
    private static class MapMultimap<K, V> extends AbstractMultimap<K, V> implements SetMultimap<K, V>, Serializable {
        ...
        public Set<V> get(@ParametricNullness final K k) {
            return new Sets.ImprovedAbstractSet<V>(this) {
                ...
                public Iterator<V> iterator() {
                    return new Iterator<V>() {
                        ...
                        public V next() {
                            if (hasNext()) {
                                this.i++;
                                return NullnessCasts.uncheckedCastNullableTToT(AnonymousClass1.this.this$0.map.get(k));
                            }
    ...
    private static class TransformedEntriesMultimap<K, V1, V2> extends AbstractMultimap<K, V2> {
        ...
        public Collection<V2> m542lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(@ParametricNullness K k, Collection<V1> collection) {
        ...
        public Collection<V2> get(@ParametricNullness K k) {
            return m542lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(k, this.fromMultimap.get(k));
        }
        ...
        public Collection<V2> removeAll(@CheckForNull Object obj) {
            return m542lambda$createAsMap$0$comgooglecommoncollectMultimaps$TransformedEntriesMultimap(obj, this.fromMultimap.removeAll(obj));
        }
    ...
    static final class AsMap<K, V> extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class EntrySet extends Maps.EntrySet<K, Collection<V>> {
            ...
            public /* synthetic */ Collection m541lambda$iterator$0$comgooglecommoncollectMultimaps$AsMap$EntrySet(Object obj) {
