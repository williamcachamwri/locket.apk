...
public final class ImmutableValueGraph<N, V> extends StandardValueGraph<N, V> {
    ...
    private static <N, V> GraphConnections<N, V> connectionsOf(ValueGraph<N, V> valueGraph, N n) {
        ImmutableValueGraph$$ExternalSyntheticLambda0 immutableValueGraph$$ExternalSyntheticLambda0 = new ImmutableValueGraph$$ExternalSyntheticLambda0(valueGraph, n);
        if (valueGraph.isDirected()) {
            return DirectedGraphConnections.ofImmutable(n, valueGraph.incidentEdges(n), immutableValueGraph$$ExternalSyntheticLambda0);
        }
        return UndirectedGraphConnections.ofImmutable(Maps.asMap(valueGraph.adjacentNodes(n), immutableValueGraph$$ExternalSyntheticLambda0));
    }
