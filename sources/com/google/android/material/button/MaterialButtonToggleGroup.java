...
public class MaterialButtonToggleGroup extends LinearLayout {
    ...
    public void addView(View view, int i, ViewGroup.LayoutParams layoutParams) {
        if (!(view instanceof MaterialButton)) {
            SentryLogcatAdapter.e(LOG_TAG, "Child views must be of type MaterialButton.");
            return;
        }
    ...
    private void checkInternal(int i, boolean z) {
        if (i == -1) {
            SentryLogcatAdapter.e(LOG_TAG, "Button ID is not valid: " + i);
            return;
        }
    ...
    public int getChildDrawingOrder(int i, int i2) {
        ...
        SentryLogcatAdapter.w(LOG_TAG, "Child order wasn't updated");
        return i2;
    }
