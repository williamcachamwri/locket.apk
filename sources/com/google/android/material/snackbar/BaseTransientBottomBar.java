...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>> {
            ...
            public void run() {
                if (BaseTransientBottomBar.this.view != null && BaseTransientBottomBar.this.context != null) {
                    ...
                    if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
                        SentryLogcatAdapter.w(BaseTransientBottomBar.TAG, "Unable to apply gesture inset because layout params are not MarginLayoutParams");
                        return;
                    }
    ...
    public void updateMargins() {
        ...
        if (!(layoutParams instanceof ViewGroup.MarginLayoutParams)) {
            SentryLogcatAdapter.w(TAG, "Unable to update margins because layout params are not MarginLayoutParams");
        } else if (this.view.originalMargins == null) {
            SentryLogcatAdapter.w(TAG, "Unable to update margins because original view margins are not set");
