...
public final class MaterialDatePicker<S> extends DialogFragment {
    ...
    public final View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        ViewCompat.setAccessibilityDelegate(this.confirmButton, new AccessibilityDelegateCompat() {
            public void onInitializeAccessibilityNodeInfo(View view, AccessibilityNodeInfoCompat accessibilityNodeInfoCompat) {
                ...
                accessibilityNodeInfoCompat.setContentDescription(MaterialDatePicker.this.getDateSelector().getError() + ", " + accessibilityNodeInfoCompat.getText());
            }
        });
    ...
    private void updateTitle(boolean z) {
        this.headerTitleTextView.setText((!z || !isLandscape()) ? this.fullTitleText : this.singleLineTitleText);
    }
