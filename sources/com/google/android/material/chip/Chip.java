...
public class Chip extends AppCompatCheckBox implements ChipDrawable.Delegate, Shapeable, MaterialCheckable<Chip> {
    ...
    public /* synthetic */ void m2130lambda$new$0$comgoogleandroidmaterialchipChip(CompoundButton compoundButton, boolean z) {
    ...
    private void validateAttributes(AttributeSet attributeSet) {
        if (attributeSet != null) {
            if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, AppStateModule.APP_STATE_BACKGROUND) != null) {
                SentryLogcatAdapter.w(TAG, "Do not set the background; Chip manages its own background drawable.");
            }
            if (attributeSet.getAttributeValue(NAMESPACE_ANDROID, "drawableLeft") != null) {
                ...
                SentryLogcatAdapter.w(TAG, "Chip text must be vertically center and start aligned");
            }
        }
    }
    ...
    public void setBackgroundTintList(ColorStateList colorStateList) {
        SentryLogcatAdapter.w(TAG, "Do not set the background tint list; Chip manages its own background drawable.");
    }

    public void setBackgroundTintMode(PorterDuff.Mode mode) {
        SentryLogcatAdapter.w(TAG, "Do not set the background tint mode; Chip manages its own background drawable.");
    }

    public void setBackgroundColor(int i) {
        SentryLogcatAdapter.w(TAG, "Do not set the background color; Chip manages its own background drawable.");
    }

    public void setBackgroundResource(int i) {
        SentryLogcatAdapter.w(TAG, "Do not set the background resource; Chip manages its own background drawable.");
    }
    ...
    public void setBackgroundDrawable(Drawable drawable) {
        if (drawable == getBackgroundDrawable() || drawable == this.ripple) {
            ...
            SentryLogcatAdapter.w(TAG, "Do not set the background drawable; Chip manages its own background drawable.");
        }
    }
