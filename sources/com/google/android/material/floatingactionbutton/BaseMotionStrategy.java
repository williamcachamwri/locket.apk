...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    public AnimatorSet createAnimator(MotionSpec motionSpec2) {
        ...
        if (motionSpec2.hasPropertyValues(ViewProps.PADDING_START)) {
            arrayList.add(motionSpec2.getAnimator(ViewProps.PADDING_START, this.fab, ExtendedFloatingActionButton.PADDING_START));
        }
        if (motionSpec2.hasPropertyValues(ViewProps.PADDING_END)) {
            arrayList.add(motionSpec2.getAnimator(ViewProps.PADDING_END, this.fab, ExtendedFloatingActionButton.PADDING_END));
        }
