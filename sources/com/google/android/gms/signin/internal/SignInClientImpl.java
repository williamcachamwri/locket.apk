...
public class SignInClientImpl extends GmsClient<zaf> implements zae {
    ...
    public final void zaa() {
        try {
            ...
            SentryLogcatAdapter.w("SignInClientImpl", "Remote service probably died when clearAccountFromSessionStore is called");
        }
    }
    ...
    public final void zac(IAccountAccessor iAccountAccessor, boolean z) {
        try {
            ...
            SentryLogcatAdapter.w("SignInClientImpl", "Remote service probably died when saveDefaultAccount is called");
        }
    }
    ...
    public final void zad(zae zae2) {
        ...
        try {
            ...
            try {
                ...
                SentryLogcatAdapter.wtf("SignInClientImpl", "ISignInCallbacks#onSignInComplete should be executed from the same process, unexpected RemoteException.", e);
            }
        }
    }
}
