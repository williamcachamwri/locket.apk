...
public final class CloudMessage extends AbstractSafeParcelable {
    ...
    public long getSentTime() {
        ...
        try {
            ...
            SentryLogcatAdapter.w("CloudMessage", "Invalid sent time: ".concat(String.valueOf(String.valueOf(obj))));
            return 0;
        }
    }
    ...
    public int getTtl() {
        ...
        try {
            ...
            SentryLogcatAdapter.w("CloudMessage", "Invalid TTL: ".concat(String.valueOf(String.valueOf(obj))));
            return 0;
        }
    }
