...
public class GoogleApiAvailability extends GoogleApiAvailabilityLight {
    ...
    public final android.app.Dialog zaa(android.content.Context r6, int r7, com.google.android.gms.common.internal.zag r8, android.content.DialogInterface.OnCancelListener r9, android.content.DialogInterface.OnClickListener r10) {
        ...
        L_0x0054:
            ...
            io.sentry.android.core.SentryLogcatAdapter.w(r8, r6, r7)
    ...
    public final void zae(Context context, int i, String str, PendingIntent pendingIntent) {
        int i2;
        String str2;
        SentryLogcatAdapter.w("GoogleApiAvailability", String.format("GMS core API Availability. ConnectionResult=%s, tag=%s", new Object[]{Integer.valueOf(i), null}), new IllegalArgumentException());
        if (i == 18) {
            zaf(context);
    ...
    public final boolean zah(Context context, ConnectionResult connectionResult, int i) {
        ...
        zae(context, connectionResult.getErrorCode(), (String) null, PendingIntent.getActivity(context, 0, GoogleApiActivity.zaa(context, errorResolutionPendingIntent, i, true), zap.zaa | C.BUFFER_FLAG_FIRST_SAMPLE));
        return true;
    }
