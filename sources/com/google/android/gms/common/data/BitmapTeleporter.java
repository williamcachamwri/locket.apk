...
public class BitmapTeleporter extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    private static final void zaa(Closeable closeable) {
        try {
            ...
            SentryLogcatAdapter.w("BitmapTeleporter", "Could not close stream", e);
        }
    }
    ...
    public void release() {
        if (!this.zae) {
            try {
                ...
                SentryLogcatAdapter.w("BitmapTeleporter", "Could not close PFD", e);
            }
        }
    }
            ...
            if (file != null) {
                try {
                    ...
                    try {
                        ...
                        DataOutputStream dataOutputStream = new DataOutputStream(new BufferedOutputStream(create));
                        try {
