    ...
    public static void zal(Result result) {
        if (result instanceof Releasable) {
            try {
                ...
                SentryLogcatAdapter.w("BasePendingResult", "Unable to release ".concat(String.valueOf(String.valueOf(result))), e);
            }
        }
    }
    ...
    public static class CallbackHandler<R extends Result> extends zau {
        ...
        public final void handleMessage(Message message) {
            ...
            if (i == 1) {
                ...
                int i2 = message.what;
                SentryLogcatAdapter.wtf("BasePendingResult", "Don't know how to handle message: " + i2, new Exception());
            } else {
