...
public class InstanceID {
    ...
    static int zzg(Context context) {
        try {
            ...
            SentryLogcatAdapter.w("InstanceID", new StringBuilder(String.valueOf(valueOf).length() + 38).append("Never happens: can't find own package ").append(valueOf).toString());
            return 0;
        }
    }
    ...
    public static synchronized InstanceID getInstance(Context context, Bundle bundle) {
        ...
        synchronized (InstanceID.class) {
            ...
            if (zzbx == null) {
                ...
                SentryLogcatAdapter.w("InstanceID", new StringBuilder(String.valueOf(packageName).length() + 73).append("Instance ID SDK is deprecated, ").append(packageName).append(" should update to use Firebase Instance ID").toString());
    ...
    static String zzd(KeyPair keyPair) {
        try {
            ...
            SentryLogcatAdapter.w("InstanceID", "Unexpected error, device missing required algorithms");
            return null;
        }
    }
