...
public final class zzmk {
    ...
    private static zzmn zza(zzmn zzmn, zzmn zzmn2, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzmn.zza()) {
            return zzmn2;
        }
        if (zzmn2.zza()) {
        ...
        BigInteger mod = zzmn.zzd.multiply(zzmn.zzd).mod(bigInteger2);
        BigInteger mod2 = zzmn2.zzd.multiply(zzmn2.zzd).mod(bigInteger2);
        BigInteger mod3 = zzmn.zzb.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmn2.zzb.multiply(mod).mod(bigInteger2);
        BigInteger mod5 = zzmn.zzc.multiply(zzmn2.zzd).mod(bigInteger2).multiply(mod2).mod(bigInteger2);
        BigInteger mod6 = zzmn2.zzc.multiply(zzmn.zzd).mod(bigInteger2).multiply(mod).mod(bigInteger2);
        if (!mod3.equals(mod4)) {
            ...
            BigInteger add = zzmn.zzd.add(zzmn2.zzd);
            ...
            return zza(zzmn, bigInteger, bigInteger2);
        }
    }

    private static zzmn zza(zzmn zzmn, BigInteger bigInteger, BigInteger bigInteger2) {
        if (zzmn.zzc.equals(BigInteger.ZERO)) {
            return zzmn.zza;
        }
        BigInteger mod = zzmn.zzb.multiply(zzmn.zzb).mod(bigInteger2);
        BigInteger mod2 = zzmn.zzc.multiply(zzmn.zzc).mod(bigInteger2);
        BigInteger mod3 = mod2.multiply(mod2).mod(bigInteger2);
        BigInteger mod4 = zzmn.zzd.multiply(zzmn.zzd).mod(bigInteger2);
        BigInteger add = zzmn.zzb.add(mod2);
        ...
        BigInteger add3 = zzmn.zzc.add(zzmn.zzd);
