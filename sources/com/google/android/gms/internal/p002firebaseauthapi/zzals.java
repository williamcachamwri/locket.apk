...
interface zzals {
    ...
    <T> void zza(T t, zzalv<T> zzalv, zzajk zzajk) throws IOException;

    void zza(List<Boolean> list) throws IOException;

    @Deprecated
    <T> void zza(List<T> list, zzalv<T> zzalv, zzajk zzajk) throws IOException;

    <K, V> void zza(Map<K, V> map, zzakx<K, V> zzakx, zzajk zzajk) throws IOException;

    float zzb() throws IOException;

    <T> void zzb(T t, zzalv<T> zzalv, zzajk zzajk) throws IOException;

    void zzb(List<zzaip> list) throws IOException;

    <T> void zzb(List<T> list, zzalv<T> zzalv, zzajk zzajk) throws IOException;
