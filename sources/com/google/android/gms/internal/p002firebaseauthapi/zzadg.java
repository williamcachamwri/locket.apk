...
public final class zzadg {
    ...
    public static com.google.firebase.FirebaseException zza(com.google.android.gms.common.api.Status r3) {
        ...
        L_0x0100:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.p002firebaseauthapi.zzadg.zza(com.google.android.gms.common.api.Status):com.google.firebase.FirebaseException");
    }
    ...
    public static FirebaseAuthMultiFactorException zza(FirebaseAuth firebaseAuth, zzzl zzzl, FirebaseUser firebaseUser) {
        zzy.zza(firebaseAuth);
        zzy.zza(zzzl);
        Pair pair = zza.get(17078);
        return new FirebaseAuthMultiFactorException((String) pair.first, (String) pair.second, zzaj.zza(zzzl, firebaseAuth, firebaseUser));
    }
