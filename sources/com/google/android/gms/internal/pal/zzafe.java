...
class zzafe extends AbstractMap {
    ...
    /* synthetic */ zzafe(int i, zzafd zzafd) {
        this.zza = i;
    }
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzafc(this, (zzafb) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int zzb2 = zzb();
        if (zzb2 != zzafe.zzb()) {
            return entrySet().equals(zzafe.entrySet());
        }
        for (int i = 0; i < zzb2; i++) {
            if (!zzg(i).equals(zzafe.zzg(i))) {
                return false;
            }
        }
        if (zzb2 != size) {
            return this.zzc.equals(zzafe.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i2 = this.zza;
        if (size == i2) {
            zzaey zzaey = (zzaey) this.zzb.remove(i2 - 1);
            zzm().put(zzaey.zza(), zzaey.getValue());
        }
