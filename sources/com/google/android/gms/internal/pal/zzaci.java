...
final class zzaci implements zzaga {
    ...
    private zzaci(zzach zzach) {
        zzadg.zzf(zzach, "output");
        this.zza = zzach;
        zzach.zza = this;
    }

    public static zzaci zza(zzach zzach) {
        zzaci zzaci = zzach.zza;
        return zzaci != null ? zzaci : new zzaci(zzach);
    }
    ...
    public final void zzd(int i, zzaby zzaby) throws IOException {
        this.zza.zze(i, zzaby);
    }
    ...
    public final void zzq(int i, Object obj, zzaer zzaer) throws IOException {
        zzach zzach = this.zza;
        zzach.zzo(i, 3);
        zzaer.zzj((zzaef) obj, zzach.zza);
        zzach.zzo(i, 4);
    }
    ...
    public final void zzv(int i, Object obj, zzaer zzaer) throws IOException {
        zzaef zzaef = (zzaef) obj;
        zzace zzace = (zzace) this.zza;
        zzace.zzq((i << 3) | 2);
    ...
    public final void zzB(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i2 < list.size()) {
                ...
                zzach.zzq((intValue2 >> 31) ^ (intValue2 + intValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzach2.zzp(i, (intValue3 >> 31) ^ (intValue3 + intValue3));
            i2++;
        }
    }
    ...
    public final void zzD(int i, List list, boolean z) throws IOException {
        ...
        if (z) {
            ...
            while (i2 < list.size()) {
                ...
                zzach.zzs((longValue2 >> 63) ^ (longValue2 + longValue2));
                i2++;
            }
            return;
        }
        while (i2 < list.size()) {
            ...
            zzach2.zzr(i, (longValue3 >> 63) ^ (longValue3 + longValue3));
            i2++;
        }
    }
