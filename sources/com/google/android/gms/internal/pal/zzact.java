...
final class zzact extends zzabj implements RandomAccess, zzadf, zzaem {
    ...
    static {
        zzact zzact = new zzact(new float[0], 0);
        zza = zzact;
        zzact.zzb();
    }
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzact.zzb, 0, this.zzb, this.zzc, zzact.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzact.zzc) {
            return false;
        }
        float[] fArr = zzact.zzb;
