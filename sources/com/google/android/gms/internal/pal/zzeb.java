...
public final class zzeb implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    public zzeb(Context context, zzdo zzdo) {
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            this.zzf = zzea;
            this.zzb.registerReceiver(zzea, intentFilter);
        }
    ...
    private final void zzi(android.view.View r4) {
        ...
        L_0x0036:
            ...
            com.google.android.gms.internal.pal.zzdl r0 = r3.zzj     // Catch:{ Exception -> 0x003f }
            r4.unregisterActivityLifecycleCallbacks(r0)     // Catch:{ Exception -> 0x003f }
        L_0x003f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.pal.zzeb.zzi(android.view.View):void");
    }
