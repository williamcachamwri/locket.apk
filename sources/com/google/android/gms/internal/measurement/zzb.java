...
public final class zzb {
    ...
    public final void zza(zzgd.zzc zzc2) throws zzc {
        zzal zzal;
        try {
            this.zzc = this.zzb.zza.zza();
            if (!(this.zzb.zza(this.zzc, (zzgd.zzd[]) zzc2.zzc().toArray(new zzgd.zzd[0])) instanceof zzaj)) {
                for (zzgd.zzb next : zzc2.zza().zzd()) {
                    List<zzgd.zzd> zzc3 = next.zzc();
                    String zzb2 = next.zzb();
                    Iterator<zzgd.zzd> it = zzc3.iterator();
                    while (true) {
                        if (it.hasNext()) {
