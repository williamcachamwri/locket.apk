...
interface zznb {
    ...
    void zza(int i, zzik zzik) throws IOException;

    <K, V> void zza(int i, zzkt<K, V> zzkt, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    @Deprecated
    void zza(int i, Object obj, zzlu zzlu) throws IOException;
    ...
    @Deprecated
    void zza(int i, List<?> list, zzlu zzlu) throws IOException;
    ...
    void zzb(int i, Object obj, zzlu zzlu) throws IOException;

    void zzb(int i, List<String> list) throws IOException;

    void zzb(int i, List<?> list, zzlu zzlu) throws IOException;
