...
public final class GetGoogleIdOption extends GetCustomCredentialOption {
    ...
    public GetGoogleIdOption(String str, String str2, boolean z, String str3, List<String> list, boolean z2, boolean z3) {
        super(GoogleIdTokenCredential.TYPE_GOOGLE_ID_TOKEN_CREDENTIAL, Companion.zza(str, str2, z, str3, list, z2, z3), Companion.zza(str, str2, z, str3, list, z2, z3), true, z3, (Set) null, 32, (DefaultConstructorMarker) null);
        boolean z4 = z;
        boolean z5 = z2;
        Intrinsics.checkNotNullParameter(str, "serverClientId");
        this.zza = str;
