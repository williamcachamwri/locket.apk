...
public final class zzi {
    ...
    private static String zzf(String str, String str2, Object... objArr) {
        if (objArr.length > 0) {
            try {
                ...
                SentryLogcatAdapter.e("PlayCore", "Unable to format ".concat(str2), e);
    ...
    public final int zzb(String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 6)) {
            return SentryLogcatAdapter.e("PlayCore", zzf(this.zza, "Play Store app is either not installed or not the official version", objArr));
        }
        return 0;
    }
    ...
    public final int zzc(Throwable th, String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 6)) {
            return SentryLogcatAdapter.e("PlayCore", zzf(this.zza, str, objArr), th);
        }
        return 0;
    }
    ...
    public final int zze(String str, Object... objArr) {
        if (Log.isLoggable("PlayCore", 5)) {
            return SentryLogcatAdapter.w("PlayCore", zzf(this.zza, "Phonesky package is not signed -- possibly self-built package. Could not verify.", objArr));
        }
        return 0;
    }
}
