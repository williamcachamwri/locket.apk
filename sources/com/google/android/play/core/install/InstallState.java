...
public abstract class InstallState {
    ...
    public static InstallState zzb(Intent intent, zzm zzm) {
        zzm.zza("List of extras in received intent needed by fromUpdateIntent:", new Object[0]);
        zzm.zza("Key: %s; value: %s", "install.status", Integer.valueOf(intent.getIntExtra("install.status", 0)));
        zzm.zza("Key: %s; value: %s", "error.code", Integer.valueOf(intent.getIntExtra("error.code", 0)));
