    ...
    static class BackendFactoryProvider {
        ...
        public BackendFactory get(String str) {
            ...
            try {
                ...
                SentryLogcatAdapter.w(MetadataBackendRegistry.TAG, String.format("Class %s is not found.", new Object[]{str2}), e);
                return null;
            } catch (IllegalAccessException e2) {
                SentryLogcatAdapter.w(MetadataBackendRegistry.TAG, String.format("Could not instantiate %s.", new Object[]{str2}), e2);
                return null;
            } catch (InstantiationException e3) {
                SentryLogcatAdapter.w(MetadataBackendRegistry.TAG, String.format("Could not instantiate %s.", new Object[]{str2}), e3);
                return null;
            } catch (NoSuchMethodException e4) {
                SentryLogcatAdapter.w(MetadataBackendRegistry.TAG, String.format("Could not instantiate %s", new Object[]{str2}), e4);
                return null;
            } catch (InvocationTargetException e5) {
                SentryLogcatAdapter.w(MetadataBackendRegistry.TAG, String.format("Could not instantiate %s", new Object[]{str2}), e5);
                return null;
            }
        }
        ...
        private Map<String, String> discover(Context context) {
            ...
            if (metadata == null) {
                SentryLogcatAdapter.w(MetadataBackendRegistry.TAG, "Could not retrieve metadata, returning empty list of transport backends.");
        ...
        private static Bundle getMetadata(Context context) {
            try {
                ...
                if (packageManager == null) {
                    SentryLogcatAdapter.w(MetadataBackendRegistry.TAG, "Context has no PackageManager.");
                    return null;
                }
                ...
                SentryLogcatAdapter.w(MetadataBackendRegistry.TAG, "TransportBackendDiscovery has no service info.");
                return null;
            } catch (PackageManager.NameNotFoundException unused) {
                SentryLogcatAdapter.w(MetadataBackendRegistry.TAG, "Application info not found.");
                return null;
            }
        }
    }
