...
interface zzqa {
    ...
    void zzd(int i, zzlg zzlg) throws IOException;
    ...
    @Deprecated
    void zzq(int i, Object obj, zzoy zzoy) throws IOException;
    ...
    void zzv(int i, Object obj, zzoy zzoy) throws IOException;
