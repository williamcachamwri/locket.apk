...
interface zzox {
    ...
    @Deprecated
    void zzC(List list, zzoy zzoy, zzmq zzmq) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzoy zzoy, zzmq zzmq) throws IOException;
    ...
    void zzt(Object obj, zzoy zzoy, zzmq zzmq) throws IOException;

    void zzu(Object obj, zzoy zzoy, zzmq zzmq) throws IOException;
