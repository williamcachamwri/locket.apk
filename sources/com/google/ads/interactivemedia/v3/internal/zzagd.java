...
class zzagd extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i2 = 0;
        if (i >= 0) {
            int compareTo = comparable.compareTo(((zzafx) this.zza[i]).zza());
            if (compareTo > 0) {
                return -(i + 2);
            }
            if (compareTo == 0) {
        ...
        while (i2 <= i) {
            int i3 = (i2 + i) / 2;
            int compareTo2 = comparable.compareTo(((zzafx) this.zza[i3]).zza());
            if (compareTo2 < 0) {
                i = i3 - 1;
    ...
    public final Object zzm(int i) {
        zzo();
        Object value = ((zzafx) this.zza[i]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i2] = new zzafx(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzagb(this, (zzaga) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int i = this.zzb;
        if (i != zzagd.zzb) {
            return entrySet().equals(zzagd.entrySet());
        }
        for (int i2 = 0; i2 < i; i2++) {
            if (!zzg(i2).equals(zzagd.zzg(i2))) {
                return false;
            }
        }
        if (i != size) {
            return this.zzc.equals(zzagd.zzc);
        }
        return true;
    }
    ...
    public final Object get(Object obj) {
        ...
        if (zzl >= 0) {
            return ((zzafx) this.zza[zzl]).getValue();
        }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int zzl = zzl(comparable);
        if (zzl >= 0) {
            return ((zzafx) this.zza[zzl]).setValue(obj);
        }
        zzo();
        if (this.zza == null) {
        ...
        if (this.zzb == 16) {
            zzafx zzafx = (zzafx) this.zza[15];
            this.zzb = 15;
            zzn().put(zzafx.zza(), zzafx.getValue());
        }
        Object[] objArr = this.zza;
        int length = objArr.length;
        System.arraycopy(objArr, i, objArr, i + 1, (16 - i) - 1);
        this.zza[i] = new zzafx(this, comparable, obj);
        this.zzb++;
        return null;
    }
