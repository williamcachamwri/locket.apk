...
final class zzadz extends zzacj implements RandomAccess, zzaec {
    ...
    public final boolean addAll(Collection collection) {
        ...
        if (Integer.MAX_VALUE - i2 >= i) {
            ...
            System.arraycopy(zzadz.zzb, 0, this.zzb, this.zzc, zzadz.zzc);
            this.zzc = i3;
            this.modCount++;
            return true;
        }
    ...
    public final /* bridge */ /* synthetic */ zzaed zzd(int i) {
        if (i >= this.zzc) {
            return new zzadz(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzadz(int[] iArr, int i, boolean z) {
        super(z);
        this.zzb = iArr;
        this.zzc = i;
    }
