...
interface zzafl {
    ...
    @Deprecated
    void zzC(List list, zzaft zzaft, zzadk zzadk) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzaft zzaft, zzadk zzadk) throws IOException;
    ...
    zzacw zzp() throws IOException;

    String zzr() throws IOException;

    String zzs() throws IOException;

    void zzt(Object obj, zzaft zzaft, zzadk zzadk) throws IOException;

    void zzu(Object obj, zzaft zzaft, zzadk zzadk) throws IOException;
