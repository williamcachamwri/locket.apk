...
final class zzagr {
    ...
    static int zzb(java.lang.String r8, byte[] r9, int r10, int r11) {
        ...
        L_0x00bd:
            r1 = r4
        L_0x00be:
            com.google.ads.interactivemedia.v3.internal.zzagq r8 = new com.google.ads.interactivemedia.v3.internal.zzagq
            int r1 = r1 + -1
            r8.<init>(r1, r0)
            throw r8
        L_0x00c6:
        ...
        L_0x00fe:
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.ads.interactivemedia.v3.internal.zzagr.zzb(java.lang.String, byte[], int, int):int");
    }
    ...
    static String zzd(byte[] bArr, int i, int i2) throws zzaeg {
        ...
        if ((((length - i) - i2) | i | i2) >= 0) {
            ...
            while (r11 < i3) {
                ...
                if (zzagp.zzd(b2)) {
                    ...
                    if (i6 < i3 - 1) {
                        int i8 = i6 + 1;
                        zzagp.zzb(b2, bArr[i6], bArr[i8], cArr, i5);
                        i5++;
                        r11 = i8 + 1;
                    } else {
                        throw new zzaeg("Protocol message had invalid UTF-8.");
                    ...
                    byte b4 = bArr[i6];
                    int i10 = i9 + 1;
                    zzagp.zza(b2, b4, bArr[i9], bArr[i10], cArr, i5);
                    i5 += 2;
                    r11 = i10 + 1;
                } else {
                    throw new zzaeg("Protocol message had invalid UTF-8.");
    ...
    static boolean zze(byte[] r5, int r6, int r7) {
        ...
        L_0x007a:
            ...
            return r5
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.ads.interactivemedia.v3.internal.zzagr.zze(byte[], int, int):boolean");
    }
}
