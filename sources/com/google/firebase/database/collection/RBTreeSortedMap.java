    ...
    private static class Builder<A, B, C> {
        ...
        private LLRBNode<A, C> buildBalancedTree(int i, int i2) {
            ...
            if (i2 == 1) {
                ...
                return new LLRBBlackValueNode(a2, getValue(a2), (LLRBNode) null, (LLRBNode) null);
            }
            int i3 = i2 / 2;
            int i4 = i + i3;
        ...
        private void buildPennant(LLRBNode.Color color, int i, int i2) {
            ...
            if (color == LLRBNode.Color.RED) {
                lLRBValueNode = new LLRBRedValueNode<>(a2, getValue(a2), (LLRBNode) null, buildBalancedTree);
            } else {
                lLRBValueNode = new LLRBBlackValueNode<>(a2, getValue(a2), (LLRBNode) null, buildBalancedTree);
            }
            if (this.root == null) {
