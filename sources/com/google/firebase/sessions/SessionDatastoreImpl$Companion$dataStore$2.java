...
final class SessionDatastoreImpl$Companion$dataStore$2 extends Lambda implements Function1<CorruptionException, Preferences> {
    ...
    public final Preferences invoke(CorruptionException corruptionException) {
        ...
        SentryLogcatAdapter.w("FirebaseSessionsRepo", "CorruptionException in sessions DataStore in " + ProcessDetailsProvider.INSTANCE.getProcessName$com_google_firebase_firebase_sessions() + FilenameUtils.EXTENSION_SEPARATOR, corruptionException);
