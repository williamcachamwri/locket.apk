...
public final class SessionsSettings {
    ...
    public final long m839getSessionRestartTimeoutUwyO8pc() {
        Duration r0 = this.localOverrideSettings.m840getSessionRestartTimeoutFghU774();
        if (r0 != null) {
            long r02 = r0.m1653unboximpl();
            if (m838isValidSessionRestartTimeoutLRDsOJo(r02)) {
                return r02;
            }
        }
        Duration r03 = this.remoteSettings.m840getSessionRestartTimeoutFghU774();
        if (r03 != null) {
            long r04 = r03.m1653unboximpl();
            if (m838isValidSessionRestartTimeoutLRDsOJo(r04)) {
                return r04;
            }
        }
    ...
    private final boolean m838isValidSessionRestartTimeoutLRDsOJo(long j) {
        return Duration.m1632isPositiveimpl(j) && Duration.m1627isFiniteimpl(j);
    }
