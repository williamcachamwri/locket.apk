...
final class StorageKt$taskState$1 extends SuspendLambda implements Function2<ProducerScope<? super TaskState<T>>, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            final StorageKt$taskState$1$$ExternalSyntheticLambda4 storageKt$taskState$1$$ExternalSyntheticLambda4 = new StorageKt$taskState$1$$ExternalSyntheticLambda4(producerScope);
            this.$this_taskState.addOnProgressListener((OnProgressListener) storageKt$taskState$1$$ExternalSyntheticLambda2);
            this.$this_taskState.addOnPausedListener((OnPausedListener) storageKt$taskState$1$$ExternalSyntheticLambda3);
            this.$this_taskState.addOnCompleteListener((OnCompleteListener) storageKt$taskState$1$$ExternalSyntheticLambda4);
            final StorageTask<T> storageTask = this.$this_taskState;
            this.label = 1;
            if (ProduceKt.awaitClose(producerScope, new Function0<Unit>() {
                public final void invoke() {
                    storageTask.removeOnProgressListener(storageKt$taskState$1$$ExternalSyntheticLambda2);
                    storageTask.removeOnPausedListener(storageKt$taskState$1$$ExternalSyntheticLambda3);
                    storageTask.removeOnCompleteListener(storageKt$taskState$1$$ExternalSyntheticLambda4);
                }
    ...
    public static final void invokeSuspend$lambda$3(ProducerScope producerScope, StorageTask.SnapshotBase snapshotBase) {
        StorageTaskScheduler.getInstance().scheduleCallback(new StorageKt$taskState$1$$ExternalSyntheticLambda1(producerScope, snapshotBase));
    }
