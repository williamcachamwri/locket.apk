...
public class QueryEngine {
    ...
    private void createCacheIndexes(Query query, QueryContext queryContext, int i) {
        ...
        if (((double) queryContext.getDocumentReadCount()) > this.relativeIndexReadCostPerDocument * ((double) i)) {
    ...
    public void setIndexAutoCreationMinCollectionSize(int i) {
        this.indexAutoCreationMinCollectionSize = i;
    }

    /* access modifiers changed from: package-private */
    public void setRelativeIndexReadCostPerDocument(double d) {
