...
public class ExponentialBackoff {
    ...
    public ExponentialBackoff(AsyncQueue asyncQueue, AsyncQueue.TimerId timerId2) {
        this(asyncQueue, timerId2, 1000, 1.5d, 60000);
    }
    ...
    public /* synthetic */ void m767lambda$backoffAndRun$0$comgooglefirebasefirestoreutilExponentialBackoff(Runnable runnable) {
        this.lastAttemptTime = new Date().getTime();
        runnable.run();
    }
