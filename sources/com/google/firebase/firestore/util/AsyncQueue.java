...
public class AsyncQueue {
    ...
    public static <TResult> Task<TResult> callTask(Executor executor2, Callable<Task<TResult>> callable) {
        ...
        executor2.execute(new AsyncQueue$$ExternalSyntheticLambda4(callable, executor2, taskCompletionSource));
    ...
    private class SynchronizedShutdownAwareExecutor implements Executor {
        ...
        SynchronizedShutdownAwareExecutor() {
            ...
            newThread.setUncaughtExceptionHandler(new AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda0(this));
        ...
        public /* synthetic */ void m765lambda$new$0$comgooglefirebasefirestoreutilAsyncQueue$SynchronizedShutdownAwareExecutor(Thread thread2, Throwable th) {
            AsyncQueue.this.panic(th);
        }
        ...
        public synchronized Task<Void> executeAndInitiateShutdown(Runnable runnable) {
            ...
            Task<Void> executeAndReportResult = executeAndReportResult(new AsyncQueue$SynchronizedShutdownAwareExecutor$$ExternalSyntheticLambda1(runnable));
    ...
    public Task<Void> enqueue(Runnable runnable) {
        return enqueue(new AsyncQueue$$ExternalSyntheticLambda0(runnable));
    }
    ...
    public void panic(Throwable th) {
        ...
        new Handler(Looper.getMainLooper()).post(new AsyncQueue$$ExternalSyntheticLambda6(th));
    }
    ...
    public void runDelayedTasksUntil(TimerId timerId) throws InterruptedException {
        runSync(new AsyncQueue$$ExternalSyntheticLambda3(this, timerId));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$runDelayedTasksUntil$6$com-google-firebase-firestore-util-AsyncQueue  reason: not valid java name */
    public /* synthetic */ void m764lambda$runDelayedTasksUntil$6$comgooglefirebasefirestoreutilAsyncQueue(TimerId timerId) {
        Assert.hardAssert(timerId == TimerId.ALL || containsDelayedTask(timerId), "Attempted to run tasks until missing TimerId: %s", timerId);
        Collections.sort(this.delayedTasks, new AsyncQueue$$ExternalSyntheticLambda1());
