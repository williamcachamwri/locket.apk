...
public class ViewSnapshot {
    ...
    public ViewSnapshot(Query query2, DocumentSet documentSet, DocumentSet documentSet2, List<DocumentViewChange> list, boolean z, ImmutableSortedSet<DocumentKey> immutableSortedSet, boolean z2, boolean z3, boolean z4) {
        this.query = query2;
    ...
    public static ViewSnapshot fromInitialDocuments(Query query2, DocumentSet documentSet, ImmutableSortedSet<DocumentKey> immutableSortedSet, boolean z, boolean z2, boolean z3) {
        ArrayList arrayList = new ArrayList();
        Iterator<Document> it = documentSet.iterator();
        while (it.hasNext()) {
            arrayList.add(DocumentViewChange.create(DocumentViewChange.Type.ADDED, it.next()));
        }
        return new ViewSnapshot(query2, documentSet, DocumentSet.emptySet(query2.comparator()), arrayList, z, immutableSortedSet, true, z2, z3);
    }
