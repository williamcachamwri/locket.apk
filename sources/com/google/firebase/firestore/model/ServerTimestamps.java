...
public final class ServerTimestamps {
    ...
    public static boolean isServerTimestamp(Value value) {
        Value value2 = null;
        if (value != null) {
            value2 = value.getMapValue().getFieldsOrDefault("__type__", (Value) null);
        }
    ...
    public static Value valueOf(Timestamp timestamp, Value value) {
        MapValue.Builder putFields = MapValue.newBuilder().putFields("__type__", (Value) Value.newBuilder().setStringValue(SERVER_TIMESTAMP_SENTINEL).build()).putFields(LOCAL_WRITE_TIME_KEY, (Value) Value.newBuilder().setTimestampValue(com.google.protobuf.Timestamp.newBuilder().setSeconds(timestamp.getSeconds()).setNanos(timestamp.getNanoseconds())).build());
