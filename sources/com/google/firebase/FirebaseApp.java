...
public class FirebaseApp {
    ...
    public static FirebaseApp initializeApp(Context context) {
        synchronized (LOCK) {
            ...
            if (fromResource == null) {
                SentryLogcatAdapter.w(LOG_TAG, "Default FirebaseApp failed to initialize because no default options were found. This usually means that com.google.gms:google-services was not applied to your gradle project.");
                return null;
            }
    ...
    public /* synthetic */ DataCollectionConfigStorage m568lambda$new$0$comgooglefirebaseFirebaseApp(Context context) {
    ...
    public /* synthetic */ void m569lambda$new$1$comgooglefirebaseFirebaseApp(boolean z) {
        if (!z) {
