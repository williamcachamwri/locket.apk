...
public final class AutoCrashlyticsReportEncoder implements Configurator {
    ...
    public void configure(EncoderConfig<?> encoderConfig) {
        ...
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.ApplicationExitInfo.BuildIdMappingForArch.class, (ObjectEncoder<? super U>) CrashlyticsReportApplicationExitInfoBuildIdMappingForArchEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) AutoValue_CrashlyticsReport_ApplicationExitInfo_BuildIdMappingForArch.class, (ObjectEncoder<? super U>) CrashlyticsReportApplicationExitInfoBuildIdMappingForArchEncoder.INSTANCE);
        ...
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.Application.ProcessDetails.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationProcessDetailsEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) AutoValue_CrashlyticsReport_Session_Event_Application_ProcessDetails.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventApplicationProcessDetailsEncoder.INSTANCE);
        ...
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.RolloutsState.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventRolloutsStateEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) AutoValue_CrashlyticsReport_Session_Event_RolloutsState.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventRolloutsStateEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.RolloutAssignment.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventRolloutAssignmentEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) AutoValue_CrashlyticsReport_Session_Event_RolloutAssignment.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventRolloutAssignmentEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) CrashlyticsReport.Session.Event.RolloutAssignment.RolloutVariant.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventRolloutAssignmentRolloutVariantEncoder.INSTANCE);
        encoderConfig.registerEncoder((Class<U>) AutoValue_CrashlyticsReport_Session_Event_RolloutAssignment_RolloutVariant.class, (ObjectEncoder<? super U>) CrashlyticsReportSessionEventRolloutAssignmentRolloutVariantEncoder.INSTANCE);
