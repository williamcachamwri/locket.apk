    ...
    private Bundle setDefaultAttributesToBundle(String str, String str2, String str3, Bundle bundle) {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(token)) {
                ...
                SentryLogcatAdapter.w("FirebaseInstanceId", "FIS auth token is empty");
            }
        } catch (InterruptedException | ExecutionException e) {
            SentryLogcatAdapter.e("FirebaseInstanceId", "Failed to get FIS auth token", e);
        }
    ...
    private String handleResponse(Bundle bundle) throws IOException {
        if (bundle != null) {
            ...
            if ("RST".equals(string3)) {
                ...
                sb.append(valueOf);
                SentryLogcatAdapter.w("FirebaseInstanceId", sb.toString(), new Throwable());
