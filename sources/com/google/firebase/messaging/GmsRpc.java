...
class GmsRpc {
    ...
    private void setDefaultAttributesToBundle(String str, String str2, Bundle bundle) throws ExecutionException, InterruptedException {
        ...
        try {
            ...
            if (!TextUtils.isEmpty(token)) {
                ...
                SentryLogcatAdapter.w("FirebaseMessaging", "FIS auth token is empty");
            }
        } catch (InterruptedException | ExecutionException e) {
            SentryLogcatAdapter.e("FirebaseMessaging", "Failed to get FIS auth token", e);
        }
    ...
    private String handleResponse(Bundle bundle) throws IOException {
        if (bundle != null) {
            ...
            if (CMD_RST.equals(string3)) {
                ...
                SentryLogcatAdapter.w("FirebaseMessaging", "Unexpected response: " + bundle, new Throwable());
    ...
    private Task<String> extractResponseWhenComplete(Task<Bundle> task) {
        return task.continueWith(new CredentialManager$$ExternalSyntheticLambda0(), new GmsRpc$$ExternalSyntheticLambda0(this));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$extractResponseWhenComplete$0$com-google-firebase-messaging-GmsRpc  reason: not valid java name */
    public /* synthetic */ String m796lambda$extractResponseWhenComplete$0$comgooglefirebasemessagingGmsRpc(Task task) throws Exception {
