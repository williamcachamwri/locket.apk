...
public class ConfigFetchHandler {
    ...
    public /* synthetic */ Task m829lambda$fetchNowWithTypeAndAttemptNumber$1$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Map map, Task task) throws Exception {
        return m826lambda$fetch$0$comgooglefirebaseremoteconfiginternalConfigFetchHandler(task, 0, map);
    }

    /* access modifiers changed from: private */
    /* renamed from: fetchIfCacheExpiredAndNotThrottled */
    public Task<FetchResponse> m826lambda$fetch$0$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Task<ConfigContainer> task, long j, Map<String, String> map) {
    ...
    public /* synthetic */ Task m827lambda$fetchIfCacheExpiredAndNotThrottled$2$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Task task, Task task2, Date date, Map map, Task task3) throws Exception {
    ...
    public /* synthetic */ Task m828lambda$fetchIfCacheExpiredAndNotThrottled$3$comgooglefirebaseremoteconfiginternalConfigFetchHandler(Date date, Task task) throws Exception {
