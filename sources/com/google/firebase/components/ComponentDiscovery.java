...
public final class ComponentDiscovery<T> {
    ...
    public List<ComponentRegistrar> discover() {
        ...
        for (String instantiate : this.retriever.retrieve(this.context)) {
            try {
                ...
                SentryLogcatAdapter.w(TAG, "Invalid component registrar.", e);
            }
        }
        return arrayList;
    }
    ...
    public static ComponentRegistrar instantiate(String str) {
        try {
            ...
            SentryLogcatAdapter.w(TAG, String.format("Class %s is not an found.", new Object[]{str}));
            return null;
    ...
    private static class MetadataRegistrarNameRetriever implements RegistrarNameRetriever<Context> {
        ...
        public List<String> retrieve(Context context) {
            ...
            if (metadata == null) {
                SentryLogcatAdapter.w(ComponentDiscovery.TAG, "Could not retrieve metadata, returning empty list of registrars.");
        ...
        private Bundle getMetadata(Context context) {
            try {
                ...
                if (packageManager == null) {
                    SentryLogcatAdapter.w(ComponentDiscovery.TAG, "Context has no PackageManager.");
                    return null;
                }
                ...
                SentryLogcatAdapter.w(ComponentDiscovery.TAG, this.discoveryService + " has no service info.");
                return null;
            } catch (PackageManager.NameNotFoundException unused) {
                SentryLogcatAdapter.w(ComponentDiscovery.TAG, "Application info not found.");
                return null;
            }
        }
    }
