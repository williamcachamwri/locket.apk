    ...
    public static void migrate(Context context) {
        if (!isAsyncStorageDatabaseCreated(context)) {
            ...
            try {
                ...
                FileInputStream create = SentryFileInputStream.Factory.create(new FileInputStream(lastModifiedFile), lastModifiedFile);
                File databasePath = context.getDatabasePath(ReactDatabaseSupplier.DATABASE_NAME);
                copyFile(create, SentryFileOutputStream.Factory.create(new FileOutputStream(databasePath), databasePath));
