    ...
    private synchronized boolean isFdSizeBelowHardwareLimit() {
        ...
        if (i >= 50) {
            ...
            if (!z && Log.isLoggable("Downsampler", 5)) {
                SentryLogcatAdapter.w("Downsampler", "Excluding HARDWARE bitmap config because we're over the file descriptor limit, file descriptors " + length + ", limit " + maxFdCount);
            }
        }
