    ...
    public static final class FileReader implements ImageReader {
        ...
        public android.graphics.Bitmap decodeBitmap(android.graphics.BitmapFactory.Options r5) throws java.io.FileNotFoundException {
            /*
                ...
                java.io.FileInputStream r2 = io.sentry.instrumentation.file.SentryFileInputStream.Factory.create((java.io.FileInputStream) r2, (java.io.File) r3)     // Catch:{ all -> 0x001e }
                ...
                android.graphics.Bitmap r5 = android.graphics.BitmapFactory.decodeStream(r1, r0, r5)     // Catch:{ all -> 0x001b }
        ...
        public com.bumptech.glide.load.ImageHeaderParser.ImageType getImageType() throws java.io.IOException {
            /*
                r5 = this;
                r0 = 0
                com.bumptech.glide.load.resource.bitmap.RecyclableBufferedInputStream r1 = new com.bumptech.glide.load.resource.bitmap.RecyclableBufferedInputStream     // Catch:{ all -> 0x0021 }
                java.io.FileInputStream r2 = new java.io.FileInputStream     // Catch:{ all -> 0x0021 }
                java.io.File r3 = r5.file     // Catch:{ all -> 0x0021 }
                r2.<init>(r3)     // Catch:{ all -> 0x0021 }
                java.io.FileInputStream r2 = io.sentry.instrumentation.file.SentryFileInputStream.Factory.create((java.io.FileInputStream) r2, (java.io.File) r3)     // Catch:{ all -> 0x0021 }
                com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r3 = r5.byteArrayPool     // Catch:{ all -> 0x0021 }
                r1.<init>(r2, r3)     // Catch:{ all -> 0x0021 }
                java.util.List<com.bumptech.glide.load.ImageHeaderParser> r0 = r5.parsers     // Catch:{ all -> 0x001f }
                com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r2 = r5.byteArrayPool     // Catch:{ all -> 0x001f }
                com.bumptech.glide.load.ImageHeaderParser$ImageType r0 = com.bumptech.glide.load.ImageHeaderParserUtils.getType((java.util.List<com.bumptech.glide.load.ImageHeaderParser>) r0, (java.io.InputStream) r1, (com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool) r2)     // Catch:{ all -> 0x001f }
        ...
        public int getImageOrientation() throws java.io.IOException {
            /*
                ...
                java.util.List<com.bumptech.glide.load.ImageHeaderParser> r0 = r5.parsers     // Catch:{ all -> 0x001f }
                com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool r2 = r5.byteArrayPool     // Catch:{ all -> 0x001f }
                int r0 = com.bumptech.glide.load.ImageHeaderParserUtils.getOrientation((java.util.List<com.bumptech.glide.load.ImageHeaderParser>) r0, (java.io.InputStream) r1, (com.bumptech.glide.load.engine.bitmap_recycle.ArrayPool) r2)     // Catch:{ all -> 0x001f }
                r1.close()     // Catch:{ IOException -> 0x001e }
            L_0x001e:
                return r0
            L_0x001f:
