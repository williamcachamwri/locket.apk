...
public final class WidgetEmptyLgBinding implements ViewBinding {
    ...
    private WidgetEmptyLgBinding(RelativeLayout relativeLayout, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, RelativeLayout relativeLayout2, FrameLayout frameLayout, ImageView imageView5) {
    ...
    public static WidgetEmptyLgBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static WidgetEmptyLgBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.widget_empty_lg, viewGroup, false);
        if (z) {
    ...
    public static WidgetEmptyLgBinding bind(View view) {
                ...
                if (imageView3 != null) {
                    ...
                    if (imageView4 != null) {
                        ...
                        if (frameLayout != null) {
                            ...
                            if (imageView5 != null) {
                                return new WidgetEmptyLgBinding(relativeLayout, imageView, imageView2, imageView3, imageView4, relativeLayout, frameLayout, imageView5);
                            }
                        }
                    }
                }
