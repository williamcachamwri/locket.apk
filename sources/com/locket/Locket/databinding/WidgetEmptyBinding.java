...
public final class WidgetEmptyBinding implements ViewBinding {
    ...
    private WidgetEmptyBinding(RelativeLayout relativeLayout, ImageView imageView, ImageView imageView2, ImageView imageView3, ImageView imageView4, RelativeLayout relativeLayout2, FrameLayout frameLayout, ImageView imageView5) {
    ...
    public static WidgetEmptyBinding inflate(LayoutInflater layoutInflater) {
        return inflate(layoutInflater, (ViewGroup) null, false);
    }

    public static WidgetEmptyBinding inflate(LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z) {
        View inflate = layoutInflater.inflate(R.layout.widget_empty, viewGroup, false);
        if (z) {
    ...
    public static WidgetEmptyBinding bind(View view) {
                ...
                if (imageView3 != null) {
                    ...
                    if (imageView4 != null) {
                        ...
                        if (frameLayout != null) {
                            ...
                            if (imageView5 != null) {
                                return new WidgetEmptyBinding(relativeLayout, imageView, imageView2, imageView3, imageView4, relativeLayout, frameLayout, imageView5);
                            }
                        }
                    }
                }
