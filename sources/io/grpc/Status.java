...
public final class Status {
    ...
    private Status(Code code2, @Nullable String str, @Nullable Throwable th) {
        this.code = (Code) Preconditions.checkNotNull(code2, UniversalFirebaseFunctionsModule.CODE_KEY);
    ...
    public String toString() {
        MoreObjects.ToStringHelper add = MoreObjects.toStringHelper((Object) this).add(UniversalFirebaseFunctionsModule.CODE_KEY, (Object) this.code.name()).add("description", (Object) this.description);
