...
final class ExceptionHandlingFrameWriter implements FrameWriter {
    ...
    public void ping(boolean z, int i, int i2) {
        if (z) {
            this.frameLogger.logPingAck(OkHttpFrameLogger.Direction.OUTBOUND, (MuxerUtil.UNSIGNED_INT_MAX_VALUE & ((long) i2)) | (((long) i) << 32));
        } else {
            this.frameLogger.logPing(OkHttpFrameLogger.Direction.OUTBOUND, (MuxerUtil.UNSIGNED_INT_MAX_VALUE & ((long) i2)) | (((long) i) << 32));
        }
        try {
