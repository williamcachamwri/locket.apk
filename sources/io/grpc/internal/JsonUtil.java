...
public class JsonUtil {
    ...
    public static Float getNumberAsFloat(Map<String, ?> map, String str) {
        ...
        if (obj instanceof String) {
            try {
                ...
                throw new IllegalArgumentException(String.format("string value '%s' for key '%s' cannot be parsed as a float", new Object[]{obj, str}));
            }
        } else {
            throw new IllegalArgumentException(String.format("value %s for key '%s' is not a float", new Object[]{obj, str}));
        }
    }
    ...
    public static Long getNumberAsLong(Map<String, ?> map, String str) {
        ...
        if (obj instanceof Double) {
            ...
            if (((double) longValue) == d.doubleValue()) {
            ...
            try {
                ...
                throw new IllegalArgumentException(String.format("value '%s' for key '%s' is not a long integer", new Object[]{obj, str}));
            }
        } else {
            throw new IllegalArgumentException(String.format("value '%s' for key '%s' is not a long integer", new Object[]{obj, str}));
        }
