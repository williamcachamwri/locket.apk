...
public final class HttpUtils {
    ...
    private static final List<String> SENSITIVE_HEADERS = Arrays.asList(new String[]{"X-FORWARDED-FOR", "AUTHORIZATION", "COOKIE", "SET-COOKIE", "X-API-KEY", "X-REAL-IP", "REMOTE-ADDR", "FORWARDED", "PROXY-AUTHORIZATION", "X-CSRF-TOKEN", "X-CSRFTOKEN", "X-XSRF-TOKEN"});
    ...
    public static List<String> filterOutSecurityCookiesFromHeader(Enumeration<String> enumeration, String str, List<String> list) {
        ...
        return filterOutSecurityCookiesFromHeader((List<String>) Collections.list(enumeration), str, list);
    }
    ...
    public static List<String> filterOutSecurityCookiesFromHeader(List<String> list, String str, List<String> list2) {
        ...
        for (String filterOutSecurityCookies : list) {
            arrayList.add(filterOutSecurityCookies(filterOutSecurityCookies, list2));
        }
        return arrayList;
    }
    ...
    public static boolean isSecurityCookie(String str, List<String> list) {
        ...
        for (String upperCase2 : list) {
            if (upperCase2.toUpperCase(Locale.ROOT).equals(upperCase)) {
                return true;
            }
        }
        return false;
