        ...
        if (str != null) {
            ...
            if (method == null) {
                try {
                    ...
                    SentryLogcatAdapter.e(TypedValues.TriggerType.NAME, "Could not find method \"" + str + "\"on class " + view.getClass().getSimpleName() + " " + Debug.getName(view));
                    return;
                }
            }
            try {
                ...
                SentryLogcatAdapter.e(TypedValues.TriggerType.NAME, "Exception in call \"" + this.mCross + "\"on class " + view.getClass().getSimpleName() + " " + Debug.getName(view));
            }
        }
    }
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    case 14:
                        ...
                        break;
                    default:
                        SentryLogcatAdapter.e(TypedValues.TriggerType.NAME, "unused attribute 0x" + Integer.toHexString(index) + "   " + mAttrMap.get(index));
                        break;
                }
            }
        }
