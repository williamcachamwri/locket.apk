            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                switch (mAttrMap.get(index)) {
                    ...
                    case 12:
                        ...
                        break;
                    default:
                        SentryLogcatAdapter.e(TypedValues.PositionType.NAME, "unused attribute 0x" + Integer.toHexString(index) + "   " + mAttrMap.get(index));
                        break;
                }
            }
            if (keyPosition.mFramePosition == -1) {
                SentryLogcatAdapter.e(TypedValues.PositionType.NAME, "no frame position");
            }
        }
    }
