            ...
            switch (c) {
                ...
                default:
                    if (!next.startsWith("CUSTOM")) {
                        SentryLogcatAdapter.e("MotionPaths", "UNKNOWN spline " + next);
                        break;
                    } else {
                        ...
                        if (!this.attributes.containsKey(str)) {
                            ...
                            if (!(viewSpline instanceof ViewSpline.CustomSet)) {
                                SentryLogcatAdapter.e("MotionPaths", next + " ViewSpline not a CustomSet frame = " + i + ", value" + constraintAttribute.getValueToInterpolate() + viewSpline);
                                break;
                            } else {
