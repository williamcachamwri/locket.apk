...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void setProgress(float f) {
        ...
        if (i < 0 || f > 1.0f) {
            SentryLogcatAdapter.w(TAG, "Warning! Progress is defined for values between 0.0 and 1.0 inclusive");
        }
        if (!isAttachedToWindow()) {
            if (this.mStateCache == null) {
                this.mStateCache = new StateCache();
    ...
    class Model {
        ...
        private void debugLayout(String str, ConstraintWidgetContainer constraintWidgetContainer) {
            ...
            for (int i = 0; i < size; i++) {
                ...
                Log.v(MotionLayout.TAG, str3 + FileSpecKt.DEFAULT_INDENT + name + " " + constraintWidget + " " + sb);
            }
        ...
        public void build() {
            ...
            L_0x007e:
                ...
                io.sentry.android.core.SentryLogcatAdapter.e(r11, r7)
                goto L_0x00ea
            L_0x00b9:
                androidx.constraintlayout.motion.widget.MotionLayout r7 = androidx.constraintlayout.motion.widget.MotionLayout.this
            ...
            L_0x0112:
                ...
                io.sentry.android.core.SentryLogcatAdapter.e(r4, r2)
            L_0x014c:
                int r5 = r5 + 1
                r2 = r16
                goto L_0x0038
    ...
    private void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            if (this.mScene == null) {
                SentryLogcatAdapter.e(TAG, "WARNING NO app:layoutDescription tag");
            }
            if (!z) {
                this.mScene = null;
            }
    ...
    private void checkStructure() {
        MotionScene motionScene = this.mScene;
        if (motionScene == null) {
            SentryLogcatAdapter.e(TAG, "CHECK: motion scene not set! set \"app:layoutDescription=\"@xml/file\"");
            return;
        }
        ...
        while (it.hasNext()) {
            ...
            if (sparseIntArray.get(startConstraintSetId) == endConstraintSetId) {
                SentryLogcatAdapter.e(TAG, "CHECK: two transitions with the same start and end " + name + "->" + name2);
            }
            if (sparseIntArray2.get(endConstraintSetId) == startConstraintSetId) {
                SentryLogcatAdapter.e(TAG, "CHECK: you can't have reverse transitions" + name + "->" + name2);
            }
            sparseIntArray.put(startConstraintSetId, endConstraintSetId);
            sparseIntArray2.put(endConstraintSetId, startConstraintSetId);
            if (this.mScene.getConstraintSet(startConstraintSetId) == null) {
                SentryLogcatAdapter.e(TAG, " no such constraintSetStart " + name);
            }
            if (this.mScene.getConstraintSet(endConstraintSetId) == null) {
                SentryLogcatAdapter.e(TAG, " no such constraintSetEnd " + name);
            }
        }
    }
    ...
    private void checkStructure(int i, ConstraintSet constraintSet) {
        ...
        for (int i2 = 0; i2 < childCount; i2++) {
            ...
            if (id == -1) {
                SentryLogcatAdapter.w(TAG, "CHECK: " + name + " ALL VIEWS SHOULD HAVE ID's " + childAt.getClass().getName() + " does not!");
            }
            if (constraintSet.getConstraint(id) == null) {
                SentryLogcatAdapter.w(TAG, "CHECK: " + name + " NO CONSTRAINTS for " + Debug.getName(childAt));
            }
        }
        ...
        for (int i3 = 0; i3 < knownIds.length; i3++) {
            ...
            if (findViewById(knownIds[i3]) == null) {
                SentryLogcatAdapter.w(TAG, "CHECK: " + name + " NO View matches id " + name2);
            }
            if (constraintSet.getHeight(i4) == -1) {
                SentryLogcatAdapter.w(TAG, "CHECK: " + name + "(" + name2 + ") no LAYOUT_HEIGHT");
            }
    ...
    private void checkStructure(MotionScene.Transition transition) {
        if (transition.getStartConstraintSetId() == transition.getEndConstraintSetId()) {
            SentryLogcatAdapter.e(TAG, "CHECK: start and end constraint set should not be the same!");
        }
    }
    ...
    public void getAnchorDpDt(int i, float f, float f2, float f3, float[] fArr) {
        ...
        SentryLogcatAdapter.w(TAG, "WARNING could not find view id " + str);
    }
    ...
    public void rebuildMotion() {
        SentryLogcatAdapter.e(TAG, "This method is deprecated. Please call rebuildScene() instead.");
        rebuildScene();
    }
    ...
    public void setTransitionDuration(int i) {
        MotionScene motionScene = this.mScene;
        if (motionScene == null) {
            SentryLogcatAdapter.e(TAG, "MotionScene not defined");
        } else {
    ...
    public void viewTransition(int i, View... viewArr) {
        ...
        if (motionScene != null) {
            ...
            SentryLogcatAdapter.e(TAG, " no motionScene");
        }
    }
