...
public class ConstraintAttribute {
    ...
    public static void setAttributes(View view, HashMap<String, ConstraintAttribute> hashMap) {
        ...
        for (String next : hashMap.keySet()) {
            ...
            try {
                ...
                SentryLogcatAdapter.e(TAG, " Custom Attribute \"" + next + "\" not found on " + cls.getName());
                SentryLogcatAdapter.e(TAG, cls.getName() + " must have a method " + str);
            } catch (IllegalAccessException e2) {
                SentryLogcatAdapter.e(TAG, " Custom Attribute \"" + next + "\" not found on " + cls.getName());
                e2.printStackTrace();
            } catch (InvocationTargetException e3) {
    ...
    public void applyCustom(View view) {
        ...
        try {
            ...
            SentryLogcatAdapter.e(TAG, e.getMessage());
            SentryLogcatAdapter.e(TAG, " Custom Attribute \"" + str + "\" not found on " + cls.getName());
            SentryLogcatAdapter.e(TAG, cls.getName() + " must have a method " + str2);
        } catch (IllegalAccessException e2) {
            SentryLogcatAdapter.e(TAG, " Custom Attribute \"" + str + "\" not found on " + cls.getName());
            e2.printStackTrace();
        } catch (InvocationTargetException e3) {
