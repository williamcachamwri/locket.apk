...
public class ConstraintSet {
                            ...
                            default:
                                switch (i2) {
                                    ...
                                    case HEIGHT_PERCENT /*70*/:
                                        ...
                                        break;
                                    case 71:
                                        SentryLogcatAdapter.e(ConstraintSet.TAG, "CURRENTLY UNSUPPORTED");
                                        break;
                                    ...
                                    case 90:
                                        ...
                                        break;
                                    case UNUSED /*91*/:
                                        SentryLogcatAdapter.w(ConstraintSet.TAG, "unused attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index));
                                        break;
                                    default:
                                        SentryLogcatAdapter.w(ConstraintSet.TAG, "Unknown attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index));
                                        break;
                                }
                        }
                }
    ...
    public void applyCustomAttributes(ConstraintLayout constraintLayout) {
        ...
        for (int i = 0; i < childCount; i++) {
            ...
            int id = childAt.getId();
            if (!this.mConstraints.containsKey(Integer.valueOf(id))) {
                SentryLogcatAdapter.w(TAG, "id unknown " + Debug.getName(childAt));
    ...
    public void parseIntAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < split.length; i++) {
            ...
            if (split2.length != 2) {
                SentryLogcatAdapter.w(TAG, " Unable to parse " + split[i]);
            } else {
    ...
    public void parseStringAttributes(Constraint constraint, String str) {
        ...
        for (int i = 0; i < splitString.length; i++) {
            ...
            SentryLogcatAdapter.w(TAG, " Unable to parse " + splitString[i]);
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (overrideMapToConstant.get(index)) {
                ...
                case HEIGHT_PERCENT /*70*/:
                    ...
                    break;
                case 71:
                    SentryLogcatAdapter.e(TAG, "CURRENTLY UNSUPPORTED");
                    break;
                case BARRIER_DIRECTION /*72*/:
                ...
                case UNUSED /*87*/:
                    SentryLogcatAdapter.w(TAG, "unused attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index));
                    break;
                ...
                case GUIDELINE_USE_RTL /*99*/:
                    ...
                    break;
                default:
                    SentryLogcatAdapter.w(TAG, "Unknown attribute 0x" + Integer.toHexString(index) + "   " + mapToConstant.get(index));
                    break;
            }
        }
    }
                    ...
                    default:
                        switch (i) {
                            ...
                            case HEIGHT_PERCENT /*70*/:
                                ...
                                return;
                            default:
                                SentryLogcatAdapter.w(TAG, "Unknown attribute 0x");
                                return;
                        }
                }
            } else {
    ...
    class WriteXmlEngine {
        ...
        public void writeLayout() throws IOException {
            ...
            for (Integer num : ConstraintSet.this.mConstraints.keySet()) {
                ...
                writeEnum("app:barrierDirection", layout2.mBarrierDirection, new String[]{"left", "right", ViewProps.TOP, ViewProps.BOTTOM, "start", "end"}, -1);
