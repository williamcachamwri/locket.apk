...
public abstract class ConstraintHelper extends View {
    ...
    public void addView(View view) {
        if (view != this) {
            if (view.getId() == -1) {
                SentryLogcatAdapter.e("ConstraintHelper", "Views added to a ConstraintHelper need to have an id");
            } else if (view.getParent() == null) {
                SentryLogcatAdapter.e("ConstraintHelper", "Views added to a ConstraintHelper need to have a parent");
            } else {
    ...
    private void addID(String str) {
        if (str != null && str.length() != 0 && this.myContext != null) {
            ...
            SentryLogcatAdapter.w("ConstraintHelper", "Could not find id of \"" + trim + "\"");
        }
    }
    ...
    private void addTag(String str) {
        if (str != null && str.length() != 0 && this.myContext != null) {
            ...
            if (constraintLayout == null) {
                SentryLogcatAdapter.w("ConstraintHelper", "Parent not a ConstraintLayout");
                return;
            }
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                if ((layoutParams instanceof ConstraintLayout.LayoutParams) && trim.equals(((ConstraintLayout.LayoutParams) layoutParams).constraintTag)) {
                    if (childAt.getId() == -1) {
                        SentryLogcatAdapter.w("ConstraintHelper", "to use ConstraintTag view " + childAt.getClass().getSimpleName() + " must have an ID");
                    } else {
