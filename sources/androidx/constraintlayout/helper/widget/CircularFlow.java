...
public class CircularFlow extends VirtualLayout {
            ...
            if (viewById != null) {
                ...
                if (iArr == null || i >= iArr.length) {
                    ...
                    if (num == null || num.intValue() == -1) {
                        SentryLogcatAdapter.e(TAG, "Added radius to view with id: " + ((String) this.mMap.get(Integer.valueOf(viewById.getId()))));
                    } else {
                        this.mCountRadius++;
                ...
                if (fArr == null || i >= fArr.length) {
                    ...
                    if (f2 == null || f2.floatValue() == -1.0f) {
                        SentryLogcatAdapter.e(TAG, "Added angle to view with id: " + ((String) this.mMap.get(Integer.valueOf(viewById.getId()))));
                    } else {
                        this.mCountAngle++;
    ...
    public void updateRadius(View view, int i) {
        if (!isUpdatable(view)) {
            SentryLogcatAdapter.e(TAG, "It was not possible to update radius to view with id: " + view.getId());
            return;
        }
    ...
    public void updateAngle(View view, float f) {
        if (!isUpdatable(view)) {
            SentryLogcatAdapter.e(TAG, "It was not possible to update angle to view with id: " + view.getId());
            return;
        }
        int indexFromId = indexFromId(view.getId());
    ...
    public void updateReference(View view, int i, float f) {
        if (!isUpdatable(view)) {
            SentryLogcatAdapter.e(TAG, "It was not possible to update radius and angle to view with id: " + view.getId());
            return;
        }
        int indexFromId = indexFromId(view.getId());
