...
public class Carousel extends MotionHelper {
    ...
    public void updateItems() {
        ...
        if (adapter != null && this.mMotionLayout != null && adapter.count() != 0) {
            ...
            if (this.backwardTransition == -1 || this.forwardTransition == -1) {
                SentryLogcatAdapter.w(TAG, "No backward or forward transitions defined for Carousel!");
    ...
    public /* synthetic */ void m328lambda$updateItems$0$androidxconstraintlayouthelperwidgetCarousel() {
