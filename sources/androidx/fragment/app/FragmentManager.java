...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public /* synthetic */ void m384lambda$new$0$androidxfragmentappFragmentManager(Configuration configuration) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m385lambda$new$1$androidxfragmentappFragmentManager(Integer num) {
    ...
    public /* synthetic */ void m386lambda$new$2$androidxfragmentappFragmentManager(MultiWindowModeChangedInfo multiWindowModeChangedInfo) {
        if (isParentAdded()) {
    ...
    public /* synthetic */ void m387lambda$new$3$androidxfragmentappFragmentManager(PictureInPictureModeChangedInfo pictureInPictureModeChangedInfo) {
        if (isParentAdded()) {
    ...
    private void throwException(RuntimeException runtimeException) {
        ...
        if (fragmentHostCallback != null) {
            try {
                fragmentHostCallback.onDump(FileSpecKt.DEFAULT_INDENT, (FileDescriptor) null, printWriter, new String[0]);
            } catch (Exception e) {
                SentryLogcatAdapter.e(TAG, "Failed dumping state", e);
            }
        } else {
            try {
                dump(FileSpecKt.DEFAULT_INDENT, (FileDescriptor) null, printWriter, new String[0]);
            } catch (Exception e2) {
    ...
    public Parcelable saveAllState() {
        ...
        Bundle saveAllStateInternal = m383lambda$attachController$4$androidxfragmentappFragmentManager();
    ...
    public Bundle m383lambda$attachController$4$androidxfragmentappFragmentManager() {
