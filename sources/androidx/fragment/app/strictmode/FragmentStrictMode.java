...
public final class FragmentStrictMode {
    ...
    public static final void m389handlePolicyViolation$lambda0(Policy policy, Violation violation) {
    ...
    public static final void m390handlePolicyViolation$lambda1(String str, Violation violation) {
        Intrinsics.checkNotNullParameter(violation, "$violation");
        SentryLogcatAdapter.e(TAG, "Policy violation with PENALTY_DEATH in " + str, violation);
        throw violation;
    }
    ...
    public static final class Policy {
        ...
        public Policy(Set<? extends Flag> set, OnViolationListener onViolationListener, Map<String, ? extends Set<Class<? extends Violation>>> map) {
            Intrinsics.checkNotNullParameter(set, NotificationsChannelSerializer.AUDIO_ATTRIBUTES_FLAGS_KEY);
