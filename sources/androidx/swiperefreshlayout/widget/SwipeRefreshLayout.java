...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent3, NestedScrollingParent2, NestedScrollingChild3, NestedScrollingChild2, NestedScrollingParent, NestedScrollingChild {
        ...
        if (actionMasked != 0) {
            if (actionMasked != 1) {
                if (actionMasked == 2) {
                    ...
                    if (i == -1) {
                        SentryLogcatAdapter.e(LOG_TAG, "Got ACTION_MOVE event but don't have an active pointer id.");
                        return false;
                    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                SentryLogcatAdapter.e(LOG_TAG, "Got ACTION_UP event but don't have an active pointer id.");
                return false;
            }
            ...
            if (findPointerIndex2 < 0) {
                SentryLogcatAdapter.e(LOG_TAG, "Got ACTION_MOVE event but have an invalid active pointer id.");
                return false;
            }
            ...
            if (actionMasked == 5) {
                ...
                if (actionIndex < 0) {
                    SentryLogcatAdapter.e(LOG_TAG, "Got ACTION_POINTER_DOWN event but have an invalid action index.");
                    return false;
                }
