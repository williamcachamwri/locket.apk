    ...
    final class QueueWorker implements Runnable {
        ...
        private void workOnQueue() {
            ...
            L_0x002c:
                ...
                androidx.camera.core.impl.utils.executor.SequentialExecutor r0 = androidx.camera.core.impl.utils.executor.SequentialExecutor.this     // Catch:{ all -> 0x006d }
                androidx.camera.core.impl.utils.executor.SequentialExecutor$WorkerRunningState r3 = androidx.camera.core.impl.utils.executor.SequentialExecutor.WorkerRunningState.IDLE     // Catch:{ all -> 0x006d }
                r0.mWorkerRunningState = r3     // Catch:{ all -> 0x006d }
                monitor-exit(r2)     // Catch:{ all -> 0x006d }
