...
public final class UseCaseConfigUtil {
    ...
    public static void updateTargetRotationAndRelatedConfigs(UseCaseConfig.Builder<?, ?, ?> builder, int i) {
        ...
        if (targetRotation != -1 && i != -1 && targetRotation != i) {
            if (Math.abs(CameraOrientationUtil.surfaceRotationToDegrees(i) - CameraOrientationUtil.surfaceRotationToDegrees(targetRotation)) % RotationOptions.ROTATE_180 == 90 && (targetResolution = imageOutputConfig.getTargetResolution((Size) null)) != null) {
