...
public final /* synthetic */ class Camera2CameraImpl$$ExternalSyntheticLambda6 implements Runnable {
    ...
    public /* synthetic */ Camera2CameraImpl$$ExternalSyntheticLambda6(Camera2CameraImpl camera2CameraImpl, String str, SessionConfig sessionConfig, UseCaseConfig useCaseConfig, StreamSpec streamSpec, List list) {
    ...
    public final void run() {
        this.f$0.m35lambda$resetUseCase$10$androidxcameracamera2internalCamera2CameraImpl(this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
    }
}
