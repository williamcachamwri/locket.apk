...
public class ExposureControl {
    ...
    public /* synthetic */ Object m65lambda$setExposureCompensationIndex$2$androidxcameracamera2internalExposureControl(int i, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m64lambda$setExposureCompensationIndex$1$androidxcameracamera2internalExposureControl(CallbackToFutureAdapter.Completer completer, int i) {
        boolean z = false;
        if (!this.mIsActive) {
            this.mExposureStateImpl.setExposureCompensationIndex(0);
