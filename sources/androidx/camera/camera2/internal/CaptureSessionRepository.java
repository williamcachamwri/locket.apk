...
class CaptureSessionRepository {
    private final CameraDevice.StateCallback mCameraStateCallback = new CameraDevice.StateCallback() {
        ...
        private void forceOnClosedCaptureSessions() {
            ...
            CaptureSessionRepository.this.mExecutor.execute(new CaptureSessionRepository$1$$ExternalSyntheticLambda1(linkedHashSet));
        }
        ...
        private void dispatchOnError(int i) {
            ...
            CaptureSessionRepository.this.mExecutor.execute(new CaptureSessionRepository$1$$ExternalSyntheticLambda0(linkedHashSet, i));
        }
