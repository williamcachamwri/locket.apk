...
public final class Camera2Config {
    ...
    public static CameraXConfig defaultConfig() {
        ...
        return new CameraXConfig.Builder().setCameraFactoryProvider(camera2Config$$ExternalSyntheticLambda0).setDeviceSurfaceManagerProvider(camera2Config$$ExternalSyntheticLambda1).setUseCaseConfigFactoryProvider(new Camera2Config$$ExternalSyntheticLambda2()).build();
    }
