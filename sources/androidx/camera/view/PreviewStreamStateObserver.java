...
final class PreviewStreamStateObserver implements Observable.Observer<CameraInternal.State> {
    ...
    public /* synthetic */ ListenableFuture m312lambda$startPreviewStreamStateFlow$0$androidxcameraviewPreviewStreamStateObserver(Void voidR) throws Exception {
    ...
    public /* synthetic */ Void m313lambda$startPreviewStreamStateFlow$1$androidxcameraviewPreviewStreamStateObserver(Void voidR) {
    ...
    public /* synthetic */ Object m314lambda$waitForCaptureResult$2$androidxcameraviewPreviewStreamStateObserver(final CameraInfo cameraInfo, List list, final CallbackToFutureAdapter.Completer completer) throws Exception {
