...
class KeyValueMapCameraCaptureResult implements CameraCaptureResult {
    ...
    public void populateExifData(ExifData.Builder builder) {
        ...
        if (num2 != null) {
            Integer num3 = (Integer) this.mKeyValues.get(CaptureResult.CONTROL_POST_RAW_SENSITIVITY_BOOST);
            if (num3 != null) {
        ...
        Integer num4 = (Integer) this.mKeyValues.get(CaptureResult.CONTROL_AWB_MODE);
        if (num4 != null) {
