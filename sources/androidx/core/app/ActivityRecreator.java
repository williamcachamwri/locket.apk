...
final class ActivityRecreator {
    ...
    protected static boolean queueOnStopIfNecessary(Object obj, int i, Activity activity) {
        try {
                    ...
                    mainHandler.postAtFrontOfQueue(new Runnable() {
                        public void run() {
                            try {
                                ...
                                SentryLogcatAdapter.e(ActivityRecreator.LOG_TAG, "Exception while invoking performStopActivity", th);
                            }
                        }
                    });
                    return true;
            ...
            SentryLogcatAdapter.e(LOG_TAG, "Exception while fetching field values", th);
            return false;
        }
    }
