...
class NotificationCompatJellybean {
            ...
            try {
                if (sExtrasField == null) {
                    ...
                    if (!Bundle.class.isAssignableFrom(declaredField.getType())) {
                        SentryLogcatAdapter.e(TAG, "Notification.extras field is not of type Bundle");
                ...
                SentryLogcatAdapter.e(TAG, "Unable to access notification extras", e);
                sExtrasFieldAccessFailed = true;
                return null;
            } catch (NoSuchFieldException e2) {
                SentryLogcatAdapter.e(TAG, "Unable to access notification extras", e2);
                sExtrasFieldAccessFailed = true;
                return null;
            }
        }
    ...
    public static androidx.core.app.NotificationCompat.Action getAction(android.app.Notification r5, int r6) {
        ...
        L_0x0040:
            ...
            io.sentry.android.core.SentryLogcatAdapter.e(r6, r2, r5)     // Catch:{ all -> 0x003e }
            r5 = 1
    ...
    private static Object[] getActionObjectsLocked(Notification notification) {
        synchronized (sActionsLock) {
            ...
            try {
                ...
                SentryLogcatAdapter.e(TAG, "Unable to access notification actions", e);
    ...
    private static boolean ensureActionReflectionReadyLocked() {
        ...
        try {
            ...
            SentryLogcatAdapter.e(TAG, "Unable to access notification actions", e2);
            sActionsAccessFailed = true;
        }
