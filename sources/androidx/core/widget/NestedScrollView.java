                ...
                if (i == 2) {
                    ...
                    if (i2 != -1) {
                        ...
                        if (findPointerIndex == -1) {
                            SentryLogcatAdapter.e(TAG, "Invalid pointerId=" + i2 + " in onInterceptTouchEvent");
                        } else {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    SentryLogcatAdapter.e(TAG, "Invalid pointerId=" + this.mActivePointerId + " in onTouchEvent");
                } else {
                    int y = (int) motionEvent.getY(findPointerIndex);
