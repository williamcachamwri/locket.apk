...
public class ViewCompat {
    ...
    private static void bindTempDetach() {
        try {
            ...
            SentryLogcatAdapter.e(TAG, "Couldn't find method", e);
        }
    ...
    public static void setChildrenDrawingOrderEnabled(ViewGroup viewGroup, boolean z) {
        if (sChildrenDrawingOrderMethod == null) {
            ...
            try {
                ...
                SentryLogcatAdapter.e(TAG, "Unable to find childrenDrawingOrderEnabled", e);
            }
        ...
        try {
            ...
            SentryLogcatAdapter.e(TAG, "Unable to invoke childrenDrawingOrderEnabled", e2);
        } catch (IllegalArgumentException e3) {
            SentryLogcatAdapter.e(TAG, "Unable to invoke childrenDrawingOrderEnabled", e3);
        } catch (InvocationTargetException e4) {
            SentryLogcatAdapter.e(TAG, "Unable to invoke childrenDrawingOrderEnabled", e4);
        }
    }
        ...
        if (accessibilityManager.isEnabled()) {
            ...
            if (view.getAccessibilityLiveRegion() != 0 || z) {
                ...
                try {
                    ...
                    SentryLogcatAdapter.e(TAG, view.getParent().getClass().getSimpleName() + " does not fully implement ViewParent", e);
                }
            }
        }
    }
