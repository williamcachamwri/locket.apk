...
public final class MenuItemCompat {
    ...
    public static MenuItem setActionProvider(MenuItem menuItem, ActionProvider actionProvider) {
        ...
        SentryLogcatAdapter.w(TAG, "setActionProvider: item does not implement SupportMenuItem; ignoring");
        return menuItem;
    }
    ...
    public static ActionProvider getActionProvider(MenuItem menuItem) {
        ...
        SentryLogcatAdapter.w(TAG, "getActionProvider: item does not implement SupportMenuItem; returning null");
        return null;
    }
