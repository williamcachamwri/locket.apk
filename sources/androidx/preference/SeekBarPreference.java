...
public class SeekBarPreference extends Preference {
    ...
    public SeekBarPreference(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mSeekBarKeyListener = new View.OnKeyListener() {
            public boolean onKey(View view, int i, KeyEvent keyEvent) {
                ...
                SentryLogcatAdapter.e(SeekBarPreference.TAG, "SeekBar view is null and hence cannot be adjusted.");
                return false;
            }
        };
    ...
    public void onBindViewHolder(PreferenceViewHolder preferenceViewHolder) {
        ...
        if (seekBar == null) {
            SentryLogcatAdapter.e(TAG, "SeekBar view is null in onBindViewHolder.");
            return;
        }
