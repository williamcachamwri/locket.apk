...
public class ViewDragHelper {
    ...
    private boolean isValidPointerForActionMove(int i) {
        ...
        SentryLogcatAdapter.e(TAG, "Ignoring pointerId=" + i + " because ACTION_DOWN was not received for this pointer before ACTION_MOVE. It likely happened because  ViewDragHelper did not receive all the events in the event stream.");
        return false;
    }
}
