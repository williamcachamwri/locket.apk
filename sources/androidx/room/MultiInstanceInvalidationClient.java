        ...
        this.mSetUpRunnable = new Runnable() {
            public void run() {
                try {
                    ...
                    SentryLogcatAdapter.w("ROOM", "Cannot register multi-instance invalidation callback", e);
                }
            }
        };
        ...
        this.mTearDownRunnable = new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    SentryLogcatAdapter.w("ROOM", "Cannot unregister multi-instance invalidation callback", e);
                }
            ...
            public void onInvalidated(Set<String> set) {
                if (!MultiInstanceInvalidationClient.this.mStopped.get()) {
                    try {
                        ...
                        SentryLogcatAdapter.w("ROOM", "Cannot broadcast invalidation", e);
                    }
                }
            }
        };
