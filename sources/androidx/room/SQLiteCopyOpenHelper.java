...
class SQLiteCopyOpenHelper implements SupportSQLiteOpenHelper {
        ...
        try {
            ...
            if (!databasePath.exists()) {
                ...
                try {
                    ...
                    if (readVersion == i) {
                        ...
                        if (this.mContext.deleteDatabase(databaseName)) {
                            try {
                                ...
                                SentryLogcatAdapter.w("ROOM", "Unable to copy database file.", e);
                            }
                        } else {
                    ...
                    SentryLogcatAdapter.w("ROOM", "Unable to read database version.", e2);
                    copyLock.unlock();
                }
            }
    ...
    private void copyDatabaseFile(File file) throws IOException {
        ...
        if (this.mCopyFromAssetPath != null) {
            ...
            readableByteChannel = SentryFileInputStream.Factory.create(new FileInputStream(file2), file2).getChannel();
        } else {
        ...
        FileUtil.copy(readableByteChannel, SentryFileOutputStream.Factory.create(new FileOutputStream(createTempFile), createTempFile).getChannel());
