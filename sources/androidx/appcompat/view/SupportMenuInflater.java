    ...
    private class MenuState {
        ...
        public void readItem(AttributeSet attributeSet) {
            ...
            if (z && this.itemActionViewLayout == 0 && this.itemActionViewClassName == null) {
                ...
                if (z) {
                    SentryLogcatAdapter.w(SupportMenuInflater.LOG_TAG, "Ignoring attribute 'actionProviderClass'. Action view already specified.");
                }
        ...
        private void setItem(MenuItem menuItem) {
            ...
            if (i2 > 0) {
                if (!z) {
                    ...
                    SentryLogcatAdapter.w(SupportMenuInflater.LOG_TAG, "Ignoring attribute 'itemActionViewLayout'. Action view already specified.");
                }
            }
        ...
        private <T> T newInstance(String str, Class<?>[] clsArr, Object[] objArr) {
            try {
                ...
                SentryLogcatAdapter.w(SupportMenuInflater.LOG_TAG, "Cannot instantiate class: " + str, e);
                return null;
            }
        }
    }
