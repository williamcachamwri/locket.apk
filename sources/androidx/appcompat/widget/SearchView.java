...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public void onVoiceClicked() {
        ...
        if (searchableInfo != null) {
            try {
                ...
                SentryLogcatAdapter.w(LOG_TAG, "Could not find voice search activity");
            }
        }
    }
    ...
    private void launchIntent(Intent intent) {
        if (intent != null) {
            try {
                ...
                SentryLogcatAdapter.e(LOG_TAG, "Failed launch activity: " + intent, e);
            }
        }
    }
    ...
    private Intent createIntentFromSuggestion(Cursor cursor, int i, String str) {
        ...
        try {
            ...
            SentryLogcatAdapter.w(LOG_TAG, "Search suggestions cursor at row " + i2 + " returned exception.", e);
            return null;
        }
    }
