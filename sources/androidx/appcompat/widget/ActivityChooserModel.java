    ...
    private void readHistoricalDataImpl() {
        try {
            ...
            try {
                ...
                SentryLogcatAdapter.e(LOG_TAG, "Error reading historical recrod file: " + this.mHistoryFileName, e);
                if (openFileInput == null) {
                }
            } catch (IOException e2) {
                SentryLogcatAdapter.e(LOG_TAG, "Error reading historical recrod file: " + this.mHistoryFileName, e2);
                if (openFileInput == null) {
                }
            } catch (Throwable th) {
                if (openFileInput != null) {
    ...
    private final class PersistHistoryAsyncTask extends AsyncTask<Object, Void, Void> {
        ...
        public java.lang.Void doInBackground(java.lang.Object... r15) {
            /*
                ...
                r6 = 0
                androidx.appcompat.widget.ActivityChooserModel r7 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ FileNotFoundException -> 0x00e7 }
                android.content.Context r7 = r7.mContext     // Catch:{ FileNotFoundException -> 0x00e7 }
                java.io.FileOutputStream r15 = r7.openFileOutput(r15, r3)     // Catch:{ FileNotFoundException -> 0x00e7 }
                org.xmlpull.v1.XmlSerializer r7 = android.util.Xml.newSerializer()
                r7.setOutput(r15, r6)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                java.lang.String r8 = "UTF-8"
                java.lang.Boolean r9 = java.lang.Boolean.valueOf(r5)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                r7.startDocument(r8, r9)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                r7.startTag(r6, r1)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                int r8 = r4.size()     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                r9 = r3
            L_0x0031:
                if (r9 >= r8) goto L_0x0064
                java.lang.Object r10 = r4.remove(r3)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                androidx.appcompat.widget.ActivityChooserModel$HistoricalRecord r10 = (androidx.appcompat.widget.ActivityChooserModel.HistoricalRecord) r10     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                r7.startTag(r6, r0)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                java.lang.String r11 = "activity"
                android.content.ComponentName r12 = r10.activity     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                java.lang.String r12 = r12.flattenToString()     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                r7.attribute(r6, r11, r12)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                java.lang.String r11 = "time"
                long r12 = r10.time     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                java.lang.String r12 = java.lang.String.valueOf(r12)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                r7.attribute(r6, r11, r12)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                java.lang.String r11 = "weight"
                float r10 = r10.weight     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                java.lang.String r10 = java.lang.String.valueOf(r10)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                r7.attribute(r6, r11, r10)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                r7.endTag(r6, r0)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                int r9 = r9 + 1
                goto L_0x0031
            L_0x0064:
                r7.endTag(r6, r1)     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
                r7.endDocument()     // Catch:{ IllegalArgumentException -> 0x00ba, IllegalStateException -> 0x0098, IOException -> 0x0076 }
            ...
            L_0x0070:
                r15.close()     // Catch:{ IOException -> 0x00dc }
                goto L_0x00dc
            L_0x0074:
                r0 = move-exception
                goto L_0x00dd
            L_0x0076:
                ...
                java.lang.StringBuilder r2 = r3.append(r2)     // Catch:{ all -> 0x0074 }
                androidx.appcompat.widget.ActivityChooserModel r3 = androidx.appcompat.widget.ActivityChooserModel.this     // Catch:{ all -> 0x0074 }
                java.lang.String r3 = r3.mHistoryFileName     // Catch:{ all -> 0x0074 }
                java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x0074 }
                java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x0074 }
                io.sentry.android.core.SentryLogcatAdapter.e(r1, r2, r0)     // Catch:{ all -> 0x0074 }
                androidx.appcompat.widget.ActivityChooserModel r0 = androidx.appcompat.widget.ActivityChooserModel.this
                r0.mCanReadHistoricalData = r5
                if (r15 == 0) goto L_0x00dc
                goto L_0x0070
            ...
            L_0x00dd:
                ...
                r15.close()     // Catch:{ IOException -> 0x00e6 }
            L_0x00e6:
                throw r0
            L_0x00e7:
                r0 = move-exception
                ...
                io.sentry.android.core.SentryLogcatAdapter.e(r1, r15, r0)
                return r6
            */
