...
class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        ...
        if (this.mSearchView.getVisibility() == 0 && this.mSearchView.getWindowVisibility() == 0) {
            try {
                ...
                SentryLogcatAdapter.w(LOG_TAG, "Search suggestions query threw an exception.", e);
            }
        }
        return null;
    }
    ...
    public void changeCursor(Cursor cursor) {
        if (this.mClosed) {
            SentryLogcatAdapter.w(LOG_TAG, "Tried to change cursor after adapter was closed.");
            if (cursor != null) {
                cursor.close();
                return;
            }
        ...
        try {
            ...
            SentryLogcatAdapter.e(LOG_TAG, "error changing cursor and caching columns", e);
        }
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        try {
            ...
            SentryLogcatAdapter.w(LOG_TAG, "Search suggestions cursor threw exception.", e);
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            SentryLogcatAdapter.w(LOG_TAG, "Icon resource not found: " + str);
            return null;
        }
    }
    ...
    private android.graphics.drawable.Drawable getDrawable(android.net.Uri r8) {
        ...
        L_0x0041:
            ...
            io.sentry.android.core.SentryLogcatAdapter.e(r0, r1, r3)     // Catch:{ FileNotFoundException -> 0x007d }
        L_0x0052:
            return r2
        L_0x0053:
            r2 = move-exception
        ...
        L_0x007d:
            ...
            io.sentry.android.core.SentryLogcatAdapter.w((java.lang.String) r0, (java.lang.String) r8)
            return r4
        */
    ...
    private Drawable getActivityIcon(ComponentName componentName) {
        ...
        try {
            ...
            SentryLogcatAdapter.w(LOG_TAG, "Invalid icon resource " + iconResource + " for " + componentName.flattenToShortString());
            return null;
        } catch (PackageManager.NameNotFoundException e) {
            SentryLogcatAdapter.w(LOG_TAG, e.toString());
            return null;
        }
    }
    ...
    private static String getStringOrNull(Cursor cursor, int i) {
        ...
        try {
            ...
            SentryLogcatAdapter.e(LOG_TAG, "unexpected error retrieving valid column from cursor, did the remote process die?", e);
            return null;
        }
    }
