...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    class DialogPopup implements SpinnerPopup, DialogInterface.OnClickListener {
        ...
        public void setBackgroundDrawable(Drawable drawable) {
            SentryLogcatAdapter.e(AppCompatSpinner.TAG, "Cannot set popup background for MODE_DIALOG, ignoring");
        }

        public void setVerticalOffset(int i) {
            SentryLogcatAdapter.e(AppCompatSpinner.TAG, "Cannot set vertical offset for MODE_DIALOG, ignoring");
        }

        public void setHorizontalOffset(int i) {
            SentryLogcatAdapter.e(AppCompatSpinner.TAG, "Cannot set horizontal offset for MODE_DIALOG, ignoring");
        }

        public void setHorizontalOriginalOffset(int i) {
            SentryLogcatAdapter.e(AppCompatSpinner.TAG, "Cannot set horizontal (original) offset for MODE_DIALOG, ignoring");
        }
    }
