...
class AppCompatTextViewAutoSizeHelper {
        ...
        if (f != this.mTextView.getPaint().getTextSize()) {
            ...
            if (this.mTextView.getLayout() != null) {
                ...
                try {
                    ...
                    SentryLogcatAdapter.w(TAG, "Failed to invoke TextView#nullLayouts() method", e);
                }
                if (!isInLayout) {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:6:0x0011, code lost:
        io.sentry.android.core.SentryLogcatAdapter.w(TAG, "Failed to invoke TextView#" + r4 + "() method", r3);
     */
    ...
    static <T> T invokeAndReturnWithDefault(java.lang.Object r3, java.lang.String r4, T r5) {
        ...
        L_0x0010:
            ...
            io.sentry.android.core.SentryLogcatAdapter.w(r1, r4, r3)
        L_0x0029:
            return r5
        */
    ...
    private static <T> T accessAndReturnWithDefault(Object obj, String str, T t) {
        try {
            ...
            SentryLogcatAdapter.w(TAG, "Failed to access TextView#" + str + " member", e);
            return t;
        }
    }
    ...
    private static Method getTextViewMethod(String str) {
        try {
            ...
            SentryLogcatAdapter.w(TAG, "Failed to retrieve TextView#" + str + "() method", e);
            return null;
        }
    }
    ...
    private static final class Api23Impl {
        ...
        static StaticLayout createStaticLayoutForMeasuring(CharSequence charSequence, Layout.Alignment alignment, int i, int i2, TextView textView, TextPaint textPaint, Impl impl) {
            ...
            try {
                ...
                SentryLogcatAdapter.w(AppCompatTextViewAutoSizeHelper.TAG, "Failed to obtain TextDirectionHeuristic, auto size may be incorrect");
            }
            return obtain.build();
        }
    }
