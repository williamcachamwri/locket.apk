...
class AppLocalesStorageHelper {
    ...
    static java.lang.String readLocales(android.content.Context r9) {
        ...
        L_0x0048:
            ...
            io.sentry.android.core.SentryLogcatAdapter.w((java.lang.String) r1, (java.lang.String) r4)     // Catch:{ all -> 0x0046 }
            if (r3 == 0) goto L_0x0050
            goto L_0x0042
        L_0x0050:
        ...
        L_0x0073:
            ...
            io.sentry.android.core.SentryLogcatAdapter.w((java.lang.String) r1, (java.lang.String) r9)
            return r2
        */
    ...
    static void persistLocales(Context context, String str) {
        ...
        try {
            ...
            try {
                ...
                SentryLogcatAdapter.w(TAG, "Storing App Locales : Failed to persist app-locales: " + str, e);
                if (openFileOutput == null) {
                    return;
                }
            } catch (Throwable th) {
            ...
            SentryLogcatAdapter.w(TAG, String.format("Storing App Locales : FileNotFoundException: Cannot open file %s for writing ", new Object[]{APPLICATION_LOCALES_RECORD_FILE}));
        }
    }
