...
class ResourcesFlusher {
    ...
    private static void flushLollipops(Resources resources) {
        ...
        if (!sDrawableCacheFieldFetched) {
            try {
                ...
                SentryLogcatAdapter.e(TAG, "Could not retrieve Resources#mDrawableCache field", e);
            }
        ...
        if (field != null) {
            try {
                ...
                SentryLogcatAdapter.e(TAG, "Could not retrieve value from Resources#mDrawableCache", e2);
                map = null;
            }
            if (map != null) {
                map.clear();
    ...
    private static void flushMarshmallows(android.content.res.Resources r4) {
        ...
        L_0x0015:
            ...
            io.sentry.android.core.SentryLogcatAdapter.e(r1, r3, r2)
        L_0x001b:
        ...
        L_0x0026:
            ...
            io.sentry.android.core.SentryLogcatAdapter.e(r1, r0, r4)
        L_0x002c:
            r4 = 0
        L_0x002d:
    ...
    private static void flushNougats(Resources resources) {
        ...
        if (!sResourcesImplFieldFetched) {
            try {
                ...
                SentryLogcatAdapter.e(TAG, "Could not retrieve Resources#mResourcesImpl field", e);
            }
        ...
        if (field != null) {
            ...
            try {
                ...
                SentryLogcatAdapter.e(TAG, "Could not retrieve value from Resources#mResourcesImpl", e2);
                obj = null;
            }
            if (obj != null) {
                if (!sDrawableCacheFieldFetched) {
                    try {
                        ...
                        SentryLogcatAdapter.e(TAG, "Could not retrieve ResourcesImpl#mDrawableCache field", e3);
                    }
                    sDrawableCacheFieldFetched = true;
                }
                ...
                if (field2 != null) {
                    try {
                        ...
                        SentryLogcatAdapter.e(TAG, "Could not retrieve value from ResourcesImpl#mDrawableCache", e4);
                    }
                }
                if (obj2 != null) {
    ...
    private static void flushThemedResourcesCache(Object obj) {
        ...
        if (!sThemedResourceCacheClazzFetched) {
            try {
                ...
                SentryLogcatAdapter.e(TAG, "Could not find ThemedResourceCache class", e);
            }
        ...
        if (cls != null) {
            if (!sThemedResourceCache_mUnthemedEntriesFieldFetched) {
                try {
                    ...
                    SentryLogcatAdapter.e(TAG, "Could not retrieve ThemedResourceCache#mUnthemedEntries field", e2);
                }
            ...
            if (field != null) {
                try {
                    ...
                    SentryLogcatAdapter.e(TAG, "Could not retrieve value from ThemedResourceCache#mUnthemedEntries", e3);
