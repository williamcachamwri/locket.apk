...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild2, NestedScrollingChild3 {
    ...
    public void setScrollingTouchSlop(int i) {
        ...
        if (i != 0) {
            if (i != 1) {
                SentryLogcatAdapter.w(TAG, "setScrollingTouchSlop(): bad argument constant " + i + "; using default value");
            } else {
    ...
    public void scrollToPosition(int i) {
        if (!this.mLayoutSuppressed) {
            ...
            LayoutManager layoutManager = this.mLayout;
            if (layoutManager == null) {
                SentryLogcatAdapter.e(TAG, "Cannot scroll to position a LayoutManager set. Call setLayoutManager with a non-null argument.");
                return;
            }
    ...
    public void smoothScrollToPosition(int i) {
        if (!this.mLayoutSuppressed) {
            LayoutManager layoutManager = this.mLayout;
            if (layoutManager == null) {
                SentryLogcatAdapter.e(TAG, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
            } else {
    ...
    public void scrollTo(int i, int i2) {
        SentryLogcatAdapter.w(TAG, "RecyclerView does not support scrolling to an absolute position. Use scrollToPosition instead");
    }

    public void scrollBy(int i, int i2) {
        LayoutManager layoutManager = this.mLayout;
        if (layoutManager == null) {
            SentryLogcatAdapter.e(TAG, "Cannot scroll without a LayoutManager set. Call setLayoutManager with a non-null argument.");
    ...
    public boolean fling(int r8, int r9) {
        /*
            ...
            io.sentry.android.core.SentryLogcatAdapter.e(r8, r9)
            return r1
        L_0x000d:
    ...
    public void assertNotInLayoutOrScroll(String str) {
        if (isComputingLayout()) {
            ...
            SentryLogcatAdapter.w(TAG, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame.", new IllegalStateException("" + exceptionLabel()));
        }
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked == 0) {
            ...
            if (findPointerIndex < 0) {
                SentryLogcatAdapter.e(TAG, "Error processing scroll; pointer index for id " + this.mScrollPointerId + " not found. Did any MotionEvents get skipped?");
                return false;
            }
    ...
    public void dispatchLayout() {
        if (this.mAdapter == null) {
            SentryLogcatAdapter.w(TAG, "No adapter attached; skipping layout");
        } else if (this.mLayout == null) {
            SentryLogcatAdapter.e(TAG, "No layout manager attached; skipping layout");
        } else {
    ...
    private void handleMissingPreInfoForChangeError(long j, ViewHolder viewHolder, ViewHolder viewHolder2) {
        ...
        SentryLogcatAdapter.e(TAG, "Problem while matching changed view holders with the newones. The pre-layout information for the change holder " + viewHolder2 + " cannot be found but it is necessary for " + viewHolder + exceptionLabel());
    }
    ...
    public static abstract class LayoutManager {
        ...
        public void onLayoutChildren(Recycler recycler, State state) {
            SentryLogcatAdapter.e(RecyclerView.TAG, "You must override onLayoutChildren(Recycler recycler, State state) ");
        }
        ...
        public void smoothScrollToPosition(RecyclerView recyclerView, State state, int i) {
            SentryLogcatAdapter.e(RecyclerView.TAG, "You must override smoothScrollToPosition to support smooth scrolling");
        }
    ...
    public static abstract class SmoothScroller {
        ...
        public void start(RecyclerView recyclerView, LayoutManager layoutManager) {
            ...
            if (this.mStarted) {
                SentryLogcatAdapter.w(RecyclerView.TAG, "An instance of " + getClass().getSimpleName() + " was started more than once. Each instance of" + getClass().getSimpleName() + " is intended to only be used once. You should create a new instance for each use.");
            }
            this.mRecyclerView = recyclerView;
        ...
        public PointF computeScrollVectorForPosition(int i) {
            ...
            SentryLogcatAdapter.w(RecyclerView.TAG, "You should override computeScrollVectorForPosition when the LayoutManager does not implement " + ScrollVectorProvider.class.getCanonicalName());
            return null;
        }
        ...
        public void onAnimation(int i, int i2) {
            ...
            if (view != null) {
                if (getChildPosition(view) == this.mTargetPosition) {
                    ...
                    SentryLogcatAdapter.e(RecyclerView.TAG, "Passed over target position while smooth scrolling.");
                    this.mTargetView = null;
                }
            }
            if (this.mRunning) {
        ...
        public static class Action {
            ...
            public void runIfNecessary(RecyclerView recyclerView) {
                ...
                if (i >= 0) {
                    ...
                    if (i2 > 10) {
                        SentryLogcatAdapter.e(RecyclerView.TAG, "Smooth Scroll action is being updated too frequently. Make sure you are not changing it unless necessary");
                    }
                    this.mChanged = false;
                } else {
                    this.mConsecutiveUpdates = 0;
