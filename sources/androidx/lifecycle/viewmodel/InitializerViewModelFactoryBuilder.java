...
public final class InitializerViewModelFactoryBuilder {
    ...
    public final <T extends ViewModel> void addInitializer(KClass<T> kClass, Function1<? super CreationExtras, ? extends T> function1) {
        ...
        throw new IllegalArgumentException(("A `initializer` with the same `clazz` has already been added: " + ViewModelProviders_jvmKt.getCanonicalName(kClass) + FilenameUtils.EXTENSION_SEPARATOR).toString());
    }
