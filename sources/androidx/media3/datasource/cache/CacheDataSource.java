...
public final class CacheDataSource implements DataSource {
    ...
    public static final class Factory implements DataSource.Factory {
        ...
        public CacheDataSource createDataSourceForRemovingDownload() {
            return createDataSourceInternal((DataSource) null, this.flags | 1, -4000);
        }
    ...
    public CacheDataSource(Cache cache2, DataSource dataSource, DataSource dataSource2, DataSink dataSink, int i, EventListener eventListener2, CacheKeyFactory cacheKeyFactory2) {
        this(cache2, dataSource, dataSource2, dataSink, cacheKeyFactory2, i, (PriorityTaskManager) null, -1000, eventListener2);
    }
