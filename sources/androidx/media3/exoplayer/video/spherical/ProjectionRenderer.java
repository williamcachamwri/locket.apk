...
final class ProjectionRenderer {
    ...
    public void init() {
        try {
            ...
            SentryLogcatAdapter.e(TAG, "Failed to initialize the program", e);
        }
    }
    ...
    public void shutdown() {
        ...
        if (glProgram != null) {
            try {
                ...
                SentryLogcatAdapter.e(TAG, "Failed to delete the shader program", e);
            }
        }
    }
