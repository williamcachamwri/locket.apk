    ...
    private static final class Renderer implements GLSurfaceView.Renderer {
        ...
        public void onSurfaceCreated(GL10 gl10, EGLConfig eGLConfig) {
            try {
                ...
                SentryLogcatAdapter.e(VideoDecoderGLSurfaceView.TAG, "Failed to set up the textures and program", e);
            }
        }
        ...
        public void onDrawFrame(GL10 gl10) {
            ...
            if (andSet != null || this.renderedOutputBuffer != null) {
                ...
                try {
                    ...
                    SentryLogcatAdapter.e(VideoDecoderGLSurfaceView.TAG, "Failed to draw a frame", e);
                }
            }
        }
        ...
        private void setupTextures() {
            try {
                ...
                SentryLogcatAdapter.e(VideoDecoderGLSurfaceView.TAG, "Failed to set up the textures", e);
            }
        }
    }
}
