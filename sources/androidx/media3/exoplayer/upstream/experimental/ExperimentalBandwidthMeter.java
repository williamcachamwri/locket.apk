...
public final class ExperimentalBandwidthMeter implements BandwidthMeter, TransferListener {
    ...
    public static final class Builder {
        ...
        public Builder setTimeToFirstByteEstimator(TimeToFirstByteEstimator timeToFirstByteEstimator2) {
            this.timeToFirstByteEstimator = timeToFirstByteEstimator2;
            return this;
        }

        public Builder setBandwidthEstimator(BandwidthEstimator bandwidthEstimator2) {
            this.bandwidthEstimator = bandwidthEstimator2;
            return this;
        }
        ...
        private static Map<Integer, Long> getInitialBitrateEstimatesForCountry(String str) {
            int[] access$100 = ExperimentalBandwidthMeter.getInitialBitrateCountryGroupAssignment(str);
            HashMap hashMap = new HashMap(8);
            hashMap.put(0, 1000000L);
            hashMap.put(2, (Long) ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI.get(access$100[0]));
            hashMap.put(3, (Long) ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_2G.get(access$100[1]));
            hashMap.put(4, (Long) ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_3G.get(access$100[2]));
            hashMap.put(5, (Long) ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_4G.get(access$100[3]));
            hashMap.put(10, (Long) ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_NSA.get(access$100[4]));
            hashMap.put(9, (Long) ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_5G_SA.get(access$100[5]));
            hashMap.put(7, (Long) ExperimentalBandwidthMeter.DEFAULT_INITIAL_BITRATE_ESTIMATES_WIFI.get(access$100[0]));
            return hashMap;
        }
    }

    private ExperimentalBandwidthMeter(Context context, Map<Integer, Long> map, TimeToFirstByteEstimator timeToFirstByteEstimator2, BandwidthEstimator bandwidthEstimator2, boolean z) {
        ...
        this.initialBitrateEstimate = getInitialBitrateEstimateForNetworkType(networkType2);
        instance.register(new ExperimentalBandwidthMeter$$ExternalSyntheticLambda0(this));
    }
    ...
    public synchronized void onNetworkTypeChanged(int r3) {
        /*
            r2 = this;
            monitor-enter(r2)
            int r0 = r2.networkType     // Catch:{ all -> 0x0035 }
            if (r0 == 0) goto L_0x000b
            boolean r1 = r2.resetOnNetworkTypeChange     // Catch:{ all -> 0x0035 }
            if (r1 != 0) goto L_0x000b
            monitor-exit(r2)
            return
        L_0x000b:
            boolean r1 = r2.networkTypeOverrideSet     // Catch:{ all -> 0x0035 }
            if (r1 == 0) goto L_0x0011
            int r3 = r2.networkTypeOverride     // Catch:{ all -> 0x0035 }
        L_0x0011:
            if (r0 != r3) goto L_0x0015
            monitor-exit(r2)
            return
        L_0x0015:
            r2.networkType = r3     // Catch:{ all -> 0x0035 }
            r0 = 1
            ...
            goto L_0x0033
        L_0x0021:
            long r0 = r2.getInitialBitrateEstimateForNetworkType(r3)     // Catch:{ all -> 0x0035 }
            r2.initialBitrateEstimate = r0     // Catch:{ all -> 0x0035 }
            androidx.media3.exoplayer.upstream.experimental.BandwidthEstimator r3 = r2.bandwidthEstimator     // Catch:{ all -> 0x0035 }
            r3.onNetworkTypeChange(r0)     // Catch:{ all -> 0x0035 }
            androidx.media3.exoplayer.upstream.TimeToFirstByteEstimator r3 = r2.timeToFirstByteEstimator     // Catch:{ all -> 0x0035 }
            r3.reset()     // Catch:{ all -> 0x0035 }
            monitor-exit(r2)
            return
        L_0x0033:
            monitor-exit(r2)
        ...
        L_0x0035:
            ...
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.media3.exoplayer.upstream.experimental.ExperimentalBandwidthMeter.onNetworkTypeChanged(int):void");
    }
