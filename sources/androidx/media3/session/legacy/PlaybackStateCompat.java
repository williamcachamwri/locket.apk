...
public final class PlaybackStateCompat implements Parcelable {
    ...
    PlaybackStateCompat(int i, long j, long j2, float f, long j3, int i2, CharSequence charSequence, long j4, List<CustomAction> list, long j5, Bundle bundle) {
        ...
        this.mUpdateTime = j4;
        this.mCustomActions = list2 == null ? ImmutableList.of() : new ArrayList<>(list2);
    ...
    PlaybackStateCompat(Parcel parcel) {
        ...
        this.mCustomActions = createTypedArrayList == null ? ImmutableList.of() : createTypedArrayList;
    ...
    public static PlaybackStateCompat fromPlaybackState(Object obj) {
        ...
        if (customActions != null) {
            ...
            for (PlaybackState.CustomAction next : customActions) {
                if (next != null) {
                    arrayList.add(CustomAction.fromCustomAction(next));
                }
            }
        }
    ...
    public Object getPlaybackState() {
        if (this.mStateFwk == null) {
            ...
            for (CustomAction customAction : this.mCustomActions) {
                PlaybackState.CustomAction customAction2 = (PlaybackState.CustomAction) customAction.getCustomAction();
                if (customAction2 != null) {
                    Api21Impl.addCustomAction(createBuilder, customAction2);
                }
            }
