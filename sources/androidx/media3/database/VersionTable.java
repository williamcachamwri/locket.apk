...
public final class VersionTable {
    ...
    public static int getVersion(SQLiteDatabase sQLiteDatabase, int i, String str) throws DatabaseIOException {
        ...
        try {
            ...
            query = sQLiteDatabase2.query(TABLE_NAME, new String[]{"version"}, WHERE_FEATURE_AND_INSTANCE_UID_EQUALS, featureAndInstanceUidArguments(i, str), (String) null, (String) null, (String) null);
            if (query.getCount() == 0) {
                if (query != null) {
                    query.close();
                }
