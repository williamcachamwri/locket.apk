...
public final class MediaFormatUtil {
    ...
    private static float getPixelWidthHeightRatio(MediaFormat mediaFormat, float f) {
        return (!mediaFormat.containsKey("sar-width") || !mediaFormat.containsKey("sar-height")) ? f : ((float) mediaFormat.getInteger("sar-width")) / ((float) mediaFormat.getInteger("sar-height"));
    }
