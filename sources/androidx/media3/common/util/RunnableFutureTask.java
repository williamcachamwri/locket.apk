...
public abstract class RunnableFutureTask<R, E extends Exception> implements RunnableFuture<R> {
    ...
    public final boolean cancel(boolean r4) {
        /*
            ...
            androidx.media3.common.util.ConditionVariable r1 = r3.finished     // Catch:{ all -> 0x002f }
        ...
        L_0x0010:
            ...
            goto L_0x002a
        L_0x0020:
            androidx.media3.common.util.ConditionVariable r4 = r3.started     // Catch:{ all -> 0x002f }
            r4.open()     // Catch:{ all -> 0x002f }
            androidx.media3.common.util.ConditionVariable r4 = r3.finished     // Catch:{ all -> 0x002f }
            r4.open()     // Catch:{ all -> 0x002f }
        L_0x002a:
    ...
    public final void run() {
        ...
        L_0x0009:
            ...
            monitor-exit(r0)     // Catch:{ all -> 0x0057 }
            androidx.media3.common.util.ConditionVariable r0 = r4.started
            r0.open()
            r0 = 0
            ...
            monitor-enter(r1)
            androidx.media3.common.util.ConditionVariable r2 = r4.finished     // Catch:{ all -> 0x002b }
        ...
        L_0x0030:
            ...
            java.lang.Object r1 = r4.cancelLock
            monitor-enter(r1)
            androidx.media3.common.util.ConditionVariable r2 = r4.finished     // Catch:{ all -> 0x0042 }
        ...
        L_0x0045:
            ...
            monitor-enter(r2)
            androidx.media3.common.util.ConditionVariable r3 = r4.finished     // Catch:{ all -> 0x0054 }
