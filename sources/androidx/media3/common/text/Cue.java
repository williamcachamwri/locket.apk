...
public final class Cue {
    ...
    public int hashCode() {
        ...
        return Objects.hashCode(charSequence, this.textAlignment, this.multiRowAlignment, this.bitmap, Float.valueOf(this.line), Integer.valueOf(this.lineType), Integer.valueOf(this.lineAnchor), Float.valueOf(this.position), Integer.valueOf(this.positionAnchor), Float.valueOf(this.size), Float.valueOf(this.bitmapHeight), Boolean.valueOf(this.windowColorSet), Integer.valueOf(this.windowColor), Integer.valueOf(this.textSizeType), Float.valueOf(this.textSize), Integer.valueOf(this.verticalType), Float.valueOf(this.shearDegrees));
    }
    ...
    public Bundle toBinderBasedBundle() {
        ...
        if (bitmap2 != null) {
            bundleWithoutBitmap.putParcelable(FIELD_BITMAP_PARCELABLE, bitmap2);
        }
        return bundleWithoutBitmap;
    }
    ...
    public static Cue fromBundle(Bundle bundle) {
        ...
        Bitmap bitmap2 = (Bitmap) bundle.getParcelable(FIELD_BITMAP_PARCELABLE);
        if (bitmap2 != null) {
