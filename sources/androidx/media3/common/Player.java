...
public interface Player {
    ...
    public static final class PositionInfo {
        ...
        public PositionInfo filterByAvailableCommands(boolean z, boolean z2) {
            ...
            int i = 0;
            int i2 = z2 ? this.mediaItemIndex : 0;
            ...
            int i3 = i;
            long j = 0;
            long j2 = z ? this.positionMs : 0;
            if (z) {
                j = this.contentPositionMs;
            }
            long j3 = j;
            int i4 = -1;
            int i5 = z ? this.adGroupIndex : -1;
            if (z) {
                i4 = this.adIndexInAdGroup;
            }
            return new PositionInfo(obj, i2, mediaItem2, obj2, i3, j2, j3, i5, i4);
        }
        ...
        public static PositionInfo fromBundle(Bundle bundle) {
            ...
            if (bundle2 == null) {
                ...
                mediaItem2 = MediaItem.fromBundle(bundle2);
            }
            return new PositionInfo((Object) null, i, mediaItem2, (Object) null, bundle.getInt(FIELD_PERIOD_INDEX, 0), bundle.getLong(FIELD_POSITION_MS, 0), bundle.getLong(FIELD_CONTENT_POSITION_MS, 0), bundle.getInt(FIELD_AD_GROUP_INDEX, -1), bundle.getInt(FIELD_AD_INDEX_IN_AD_GROUP, -1));
        }
    }
