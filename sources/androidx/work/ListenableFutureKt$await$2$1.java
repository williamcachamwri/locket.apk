...
public final class ListenableFutureKt$await$2$1 implements Runnable {
    ...
    public final void run() {
        try {
            ...
            this.$cancellableContinuation.resumeWith(Result.m2444constructorimpl(obj));
        } catch (Throwable th) {
            ...
            this.$cancellableContinuation.resumeWith(Result.m2444constructorimpl(ResultKt.createFailure(cause)));
        }
    }
}
