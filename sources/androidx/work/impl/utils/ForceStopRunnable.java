...
public class ForceStopRunnable implements Runnable {
    ...
    public boolean isForceStopped() {
        try {
            PendingIntent pendingIntent = getPendingIntent(this.mContext, BuildCompat.isAtLeastS() ? 570425344 : C.BUFFER_FLAG_LAST_SAMPLE);
    ...
    static void setAlarm(Context context) {
        ...
        PendingIntent pendingIntent = getPendingIntent(context, BuildCompat.isAtLeastS() ? 167772160 : C.BUFFER_FLAG_FIRST_SAMPLE);
