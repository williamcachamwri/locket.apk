...
public class WorkManagerImpl extends WorkManager {
    ...
    public PendingIntent createCancelPendingIntent(UUID uuid) {
        return PendingIntent.getService(this.mContext, 0, SystemForegroundDispatcher.createCancelWorkIntent(this.mContext, uuid.toString()), BuildCompat.isAtLeastS() ? 167772160 : C.BUFFER_FLAG_FIRST_SAMPLE);
    }
