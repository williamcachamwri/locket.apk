...
public class CustomTabsClient {
    ...
    public static String getPackageName(Context context, List<String> list, boolean z) {
        ...
        SentryLogcatAdapter.w(TAG, "Unable to find any Custom Tabs packages, you may need to add a <queries> element to your manifest. See the docs for CustomTabsClient#getPackageName.");
        return null;
    }
