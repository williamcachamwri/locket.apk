...
class FrameworkSQLiteDatabase implements SupportSQLiteDatabase {
    ...
    public Cursor query(final SupportSQLiteQuery supportSQLiteQuery) {
        ...
        ISpan startChild = span != null ? span.startChild("db.sql.query", supportSQLiteQuery.getSql()) : null;
        try {
            Cursor rawQueryWithFactory = this.mDelegate.rawQueryWithFactory(new SQLiteDatabase.CursorFactory() {
