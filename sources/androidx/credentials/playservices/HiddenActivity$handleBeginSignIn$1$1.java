...
final class HiddenActivity$handleBeginSignIn$1$1 extends Lambda implements Function1<BeginSignInResult, Unit> {
    ...
    public final void invoke(BeginSignInResult beginSignInResult) {
        try {
            ...
            hiddenActivity.setupFailure(access$getResultReceiver$p, CredentialProviderBaseController.GET_UNKNOWN, "During begin sign in, one tap ui intent sender failure: " + e.getMessage());
        }
    }
}
