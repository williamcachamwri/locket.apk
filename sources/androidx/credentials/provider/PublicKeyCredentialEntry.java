...
public final class PublicKeyCredentialEntry extends CredentialEntry {
    ...
    public PublicKeyCredentialEntry(CharSequence charSequence, CharSequence charSequence2, CharSequence charSequence3, PendingIntent pendingIntent2, Icon icon2, Instant instant, boolean z, BeginGetPublicKeyCredentialOption beginGetPublicKeyCredentialOption, boolean z2, boolean z3) {
        ...
        if (charSequence.length() > 0) {
            if (!(charSequence3.length() <= 0 ? false : z4)) {
    ...
    private static final class Api28Impl {
        ...
        public static final Slice toSlice(PublicKeyCredentialEntry publicKeyCredentialEntry) {
            ...
            Slice.Builder addIcon = new Slice.Builder(Uri.EMPTY, new SliceSpec(type, 1)).addText(typeDisplayName, (String) null, CollectionsKt.listOf(PublicKeyCredentialEntry.SLICE_HINT_TYPE_DISPLAY_NAME)).addText(username, (String) null, CollectionsKt.listOf(PublicKeyCredentialEntry.SLICE_HINT_TITLE)).addText(displayName, (String) null, CollectionsKt.listOf(PublicKeyCredentialEntry.SLICE_HINT_SUBTITLE)).addText(isAutoSelectAllowed ? PublicKeyCredentialEntry.AUTO_SELECT_TRUE_STRING : "false", (String) null, CollectionsKt.listOf(PublicKeyCredentialEntry.SLICE_HINT_AUTO_ALLOWED)).addText(beginGetCredentialOption.getId(), (String) null, CollectionsKt.listOf(PublicKeyCredentialEntry.SLICE_HINT_OPTION_ID)).addIcon(icon, (String) null, CollectionsKt.listOf(PublicKeyCredentialEntry.SLICE_HINT_ICON));
            try {
                if (icon.getResId() == R.drawable.ic_passkey) {
                    addIcon.addInt(1, (String) null, CollectionsKt.listOf(PublicKeyCredentialEntry.SLICE_HINT_DEFAULT_ICON_RES_ID));
                }
            ...
            if (CredentialOption.Companion.extractAutoSelectValue$credentials_release(beginGetCredentialOption.getCandidateQueryData())) {
                addIcon.addInt(1, (String) null, CollectionsKt.listOf(PublicKeyCredentialEntry.SLICE_HINT_AUTO_SELECT_FROM_OPTION));
            }
            if (lastUsedTime != null) {
                addIcon.addLong(lastUsedTime.toEpochMilli(), (String) null, CollectionsKt.listOf(PublicKeyCredentialEntry.SLICE_HINT_LAST_USED_TIME_MILLIS));
            }
        ...
        public static final PublicKeyCredentialEntry fromSlice(Slice slice) {
            ...
            for (SliceItem sliceItem : items) {
                if (sliceItem.hasHint(PublicKeyCredentialEntry.SLICE_HINT_TYPE_DISPLAY_NAME)) {
                    ...
                    if (Intrinsics.areEqual((Object) sliceItem.getText(), (Object) PublicKeyCredentialEntry.AUTO_SELECT_TRUE_STRING)) {
                        z = true;
                    }
    ...
    public static final class Builder {
        ...
        public final PublicKeyCredentialEntry build() {
            ...
            return new PublicKeyCredentialEntry(this.username, this.displayName, string, pendingIntent2, icon2, this.lastUsedTime, this.autoSelectAllowed, this.beginGetPublicKeyCredentialOption, false, false, ViewUtils.EDGE_TO_EDGE_FLAGS, (DefaultConstructorMarker) null);
        }
    }
}
