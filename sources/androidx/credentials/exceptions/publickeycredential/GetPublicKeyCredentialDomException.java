...
public final class GetPublicKeyCredentialDomException extends GetPublicKeyCredentialException {
    ...
    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ GetPublicKeyCredentialDomException(DomError domError2, CharSequence charSequence, int i, DefaultConstructorMarker defaultConstructorMarker) {
    ...
    public static final class Companion {
        ...
        public final GetCredentialException createFrom(String str, String str2) {
            ...
            try {
                ...
                if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_ABORT_ERROR")) {
                    obj = companion.generateException(new AbortError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_CONSTRAINT_ERROR")) {
                    obj = companion.generateException(new ConstraintError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_DATA_CLONE_ERROR")) {
                    obj = companion.generateException(new DataCloneError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_DATA_ERROR")) {
                    obj = companion.generateException(new DataError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_ENCODING_ERROR")) {
                    obj = companion.generateException(new EncodingError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_HIERARCHY_REQUEST_ERROR")) {
                    obj = companion.generateException(new HierarchyRequestError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_IN_USE_ATTRIBUTE_ERROR")) {
                    obj = companion.generateException(new InUseAttributeError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_INVALID_CHARACTER_ERROR")) {
                    obj = companion.generateException(new InvalidCharacterError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_INVALID_MODIFICATION_ERROR")) {
                    obj = companion.generateException(new InvalidModificationError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_INVALID_NODE_TYPE_ERROR")) {
                    obj = companion.generateException(new InvalidNodeTypeError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_INVALID_STATE_ERROR")) {
                    obj = companion.generateException(new InvalidStateError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_NAMESPACE_ERROR")) {
                    obj = companion.generateException(new NamespaceError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_NETWORK_ERROR")) {
                    obj = companion.generateException(new NetworkError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_NO_MODIFICATION_ALLOWED_ERROR")) {
                    obj = companion.generateException(new NoModificationAllowedError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_NOT_ALLOWED_ERROR")) {
                    obj = companion.generateException(new NotAllowedError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_NOT_FOUND_ERROR")) {
                    obj = companion.generateException(new NotFoundError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_NOT_READABLE_ERROR")) {
                    obj = companion.generateException(new NotReadableError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_NOT_SUPPORTED_ERROR")) {
                    obj = companion.generateException(new NotSupportedError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_OPERATION_ERROR")) {
                    obj = companion.generateException(new OperationError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_OPT_OUT_ERROR")) {
                    obj = companion.generateException(new OptOutError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_QUOTA_EXCEEDED_ERROR")) {
                    obj = companion.generateException(new QuotaExceededError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_READ_ONLY_ERROR")) {
                    obj = companion.generateException(new ReadOnlyError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_SECURITY_ERROR")) {
                    obj = companion.generateException(new SecurityError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_SYNTAX_ERROR")) {
                    obj = companion.generateException(new SyntaxError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_TIMEOUT_ERROR")) {
                    obj = companion.generateException(new TimeoutError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_TRANSACTION_INACTIVE_ERROR")) {
                    obj = companion.generateException(new TransactionInactiveError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_UNKNOWN_ERROR")) {
                    obj = companion.generateException(new UnknownError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_VERSION_ERROR")) {
                    obj = companion.generateException(new VersionError(), str2, getPublicKeyCredentialDomException);
                } else if (Intrinsics.areEqual((Object) str, (Object) "androidx.credentials.TYPE_GET_PUBLIC_KEY_CREDENTIAL_DOM_EXCEPTION/androidx.credentials.TYPE_WRONG_DOCUMENT_ERROR")) {
