...
public final class PrepareGetCredentialResponse {
    ...
    public /* synthetic */ PrepareGetCredentialResponse(PendingGetCredentialHandle pendingGetCredentialHandle2, Function0 function0, Function0 function02, Function1 function1, boolean z, DefaultConstructorMarker defaultConstructorMarker) {
        this(pendingGetCredentialHandle2, function0, function02, function1, z);
    }

    private PrepareGetCredentialResponse(PendingGetCredentialHandle pendingGetCredentialHandle2, Function0<Boolean> function0, Function0<Boolean> function02, Function1<? super String, Boolean> function1, boolean z) {
        ...
        if (Build.VERSION.SDK_INT >= 34 && !z) {
            Intrinsics.checkNotNull(pendingGetCredentialHandle2);
        }
    }
    ...
    public static final class Builder {
        ...
        public final Builder setPendingGetCredentialHandle(PendingGetCredentialHandle pendingGetCredentialHandle2) {
            Intrinsics.checkNotNullParameter(pendingGetCredentialHandle2, "handle");
            this.pendingGetCredentialHandle = pendingGetCredentialHandle2;
            return this;
        }
