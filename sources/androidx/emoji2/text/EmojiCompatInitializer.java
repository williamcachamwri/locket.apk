...
public class EmojiCompatInitializer implements Initializer<Boolean> {
    ...
    static class BackgroundDefaultLoader implements EmojiCompat.MetadataRepoLoader {
        ...
        /* access modifiers changed from: package-private */
        /* renamed from: doLoad */
        public void m378lambda$load$0$androidxemoji2textEmojiCompatInitializer$BackgroundDefaultLoader(final EmojiCompat.MetadataRepoLoaderCallback metadataRepoLoaderCallback, final ThreadPoolExecutor threadPoolExecutor) {
            try {
