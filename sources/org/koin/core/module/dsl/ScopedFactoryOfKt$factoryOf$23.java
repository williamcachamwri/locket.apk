...
public final class ScopedFactoryOfKt$factoryOf$23 extends Lambda implements Function2<Scope, ParametersHolder, R> {
    ...
    public final R invoke(Scope scope, ParametersHolder parametersHolder) {
        Scope scope2 = scope;
        Intrinsics.checkNotNullParameter(scope2, "$this$factory");
        ...
        Object obj15 = scope2.get(Reflection.getOrCreateKotlinClass(Object.class), (Qualifier) null, (Function0<? extends ParametersHolder>) null);
        ...
        return function22.invoke(obj, obj2, obj3, obj4, obj5, obj6, obj7, obj8, obj9, obj10, obj11, obj12, obj13, obj14, obj15, obj16, obj17, obj18, obj19, obj20, obj21, scope2.get(Reflection.getOrCreateKotlinClass(Object.class), (Qualifier) null, (Function0<? extends ParametersHolder>) null));
    }
}
