...
public final class SingleOfKt$singleOf$23 extends Lambda implements Function2<Scope, ParametersHolder, R> {
    ...
    public final R invoke(Scope scope, ParametersHolder parametersHolder) {
        Scope scope2 = scope;
        Intrinsics.checkNotNullParameter(scope2, "$this$single");
