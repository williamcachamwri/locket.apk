...
final class ContactsModule$sortContactsBy$2 extends Lambda implements Function2<Contact, Contact, Integer> {
    public static final ContactsModule$sortContactsBy$2 INSTANCE = new ContactsModule$sortContactsBy$2();

    ContactsModule$sortContactsBy$2() {
        super(2);
    }
