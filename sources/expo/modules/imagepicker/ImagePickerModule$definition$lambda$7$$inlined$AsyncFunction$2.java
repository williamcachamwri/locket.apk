...
public final class ImagePickerModule$definition$lambda$7$$inlined$AsyncFunction$2 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ ImagePickerModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ImagePickerModule$definition$lambda$7$$inlined$AsyncFunction$2(ImagePickerModule imagePickerModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        if (bool != null) {
            ...
            Permissions.askForPermissionsWithPermissionsManager(permissions, promise, (String[]) Arrays.copyOf(access$getMediaLibraryPermissions, access$getMediaLibraryPermissions.length));
            return;
        }
