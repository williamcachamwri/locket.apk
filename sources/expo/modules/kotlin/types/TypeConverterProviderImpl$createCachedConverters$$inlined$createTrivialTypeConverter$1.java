...
public final class TypeConverterProviderImpl$createCachedConverters$$inlined$createTrivialTypeConverter$1 extends DynamicAwareTypeConverters<Integer> {
    final /* synthetic */ ExpectedType $cppRequireType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TypeConverterProviderImpl$createCachedConverters$$inlined$createTrivialTypeConverter$1(boolean z, ExpectedType expectedType) {
        super(z);
