...
public final class EitherOfThreeTypeConverter<FirstType, SecondType, ThirdType> extends NullAwareTypeConverter<EitherOfThree<FirstType, SecondType, ThirdType>> {
    ...
    public EitherOfThree<FirstType, SecondType, ThirdType> convertNonOptional(Object obj, AppContext appContext) {
        Intrinsics.checkNotNullParameter(obj, "value");
        List listOf = CollectionsKt.listOf(this.firstJavaType, this.secondJavaType, this.thirdJavaType);
        return new EitherOfThree<>(obj, CollectionsKt.toMutableList(EitherTypeConverterKt.createDeferredValues(obj, appContext, CollectionsKt.listOf(TuplesKt.to(this.firstType, this.firstTypeConverter), TuplesKt.to(this.secondType, this.secondTypeConverter), TuplesKt.to(this.thirdType, this.thirdTypeConverter)), listOf)), listOf);
    }
