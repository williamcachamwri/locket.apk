...
public final class TypeConverterProviderImpl$createCachedConverters$$inlined$createTrivialTypeConverter$6 extends DynamicAwareTypeConverters<String> {
    final /* synthetic */ ExpectedType $cppRequireType;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public TypeConverterProviderImpl$createCachedConverters$$inlined$createTrivialTypeConverter$6(boolean z, ExpectedType expectedType) {
        super(z);
