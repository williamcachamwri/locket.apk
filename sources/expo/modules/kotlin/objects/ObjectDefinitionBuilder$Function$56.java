...
public final class ObjectDefinitionBuilder$Function$56 extends Lambda implements Function1<Object[], Object> {
    final /* synthetic */ Function8<P0, P1, P2, P3, P4, P5, P6, P7, R> $body;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ObjectDefinitionBuilder$Function$56(Function8<? super P0, ? super P1, ? super P2, ? super P3, ? super P4, ? super P5, ? super P6, ? super P7, ? extends R> function8) {
        super(1);
        this.$body = function8;
    }
