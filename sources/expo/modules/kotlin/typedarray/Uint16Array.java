...
public final class Uint16Array implements TypedArray, GenericTypedArray<UShort>, RawTypedArrayHolder {
    ...
    public /* bridge */ /* synthetic */ Object get(int i) {
        return UShort.m2719boximpl(m2295getBwKQO78(i));
    }
    ...
    public /* bridge */ /* synthetic */ void set(int i, Object obj) {
        m2296seti8woANY(i, ((UShort) obj).m2775unboximpl());
    }

    /* renamed from: get-BwKQO78  reason: not valid java name */
    public short m2295getBwKQO78(int i) {
        TypedArray typedArray = this;
        if (i >= 0 && i < typedArray.getLength()) {
            return UShort.m2725constructorimpl(read2Byte(i * 2));
        }
        throw new IndexOutOfBoundsException();
    }

    /* renamed from: set-i8woANY  reason: not valid java name */
    public void m2296seti8woANY(int i, short s) {
        TypedArray typedArray = this;
        if (i < 0 || i >= typedArray.getLength()) {
            throw new IndexOutOfBoundsException();
        }
