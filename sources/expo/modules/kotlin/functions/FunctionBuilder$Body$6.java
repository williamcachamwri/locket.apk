...
public final class FunctionBuilder$Body$6 extends Lambda implements Function1<Object[], Object> {
    final /* synthetic */ Function1<P0, R> $body;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FunctionBuilder$Body$6(Function1<? super P0, ? extends R> function1) {
        super(1);
        this.$body = function1;
    }
