...
public final class ActivityResultsManager$registerForActivityResult$$inlined$withActivityAvailable$1 implements OnActivityAvailableListener {
    ...
    public void onActivityAvailable(AppCompatActivity appCompatActivity) {
        ...
        try {
            ...
            obj = Result.m2444constructorimpl(this.this$0.registry.register("AppContext_rq#" + this.this$0.nextLocalRequestCode.getAndIncrement(), appCompatActivity, this.$contract$inlined, this.$fallbackCallback$inlined));
        } catch (Throwable th) {
