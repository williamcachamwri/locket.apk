...
public final class PushTokenModule$definition$lambda$4$$inlined$AsyncFunction$1 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ PushTokenModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public PushTokenModule$definition$lambda$4$$inlined$AsyncFunction$1(PushTokenModule pushTokenModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        FirebaseMessaging.getInstance().getToken().addOnCompleteListener(new PushTokenModule$definition$1$3$1(promise, this.this$0));
    }
}
