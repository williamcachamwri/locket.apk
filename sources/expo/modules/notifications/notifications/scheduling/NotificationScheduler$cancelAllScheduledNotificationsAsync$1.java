...
final class NotificationScheduler$cancelAllScheduledNotificationsAsync$1 extends Lambda implements Function2<Integer, Bundle, Unit> {
    final /* synthetic */ Promise $promise;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    NotificationScheduler$cancelAllScheduledNotificationsAsync$1(Promise promise) {
        super(2);
    ...
    public final void invoke(int i, Bundle bundle) {
        ...
        this.$promise.reject("ERR_NOTIFICATIONS_FAILED_TO_CANCEL", "Failed to cancel all notifications.", exc);
    }
}
