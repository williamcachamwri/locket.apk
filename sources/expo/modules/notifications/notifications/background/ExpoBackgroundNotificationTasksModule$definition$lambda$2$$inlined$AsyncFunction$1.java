...
public final class ExpoBackgroundNotificationTasksModule$definition$lambda$2$$inlined$AsyncFunction$1 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ ExpoBackgroundNotificationTasksModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ExpoBackgroundNotificationTasksModule$definition$lambda$2$$inlined$AsyncFunction$1(ExpoBackgroundNotificationTasksModule expoBackgroundNotificationTasksModule) {
        super(2);
