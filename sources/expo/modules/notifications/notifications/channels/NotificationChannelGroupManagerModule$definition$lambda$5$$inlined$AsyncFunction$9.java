...
public final class NotificationChannelGroupManagerModule$definition$lambda$5$$inlined$AsyncFunction$9 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ NotificationChannelGroupManagerModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NotificationChannelGroupManagerModule$definition$lambda$5$$inlined$AsyncFunction$9(NotificationChannelGroupManagerModule notificationChannelGroupManagerModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        access$getGroupManager$p.deleteNotificationChannelGroup(str);
    }
