...
public final class NotificationChannelManagerModule$definition$lambda$5$$inlined$AsyncFunction$3 extends Lambda implements Function1<Object[], Object> {
    final /* synthetic */ NotificationChannelManagerModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NotificationChannelManagerModule$definition$lambda$5$$inlined$AsyncFunction$3(NotificationChannelManagerModule notificationChannelManagerModule) {
        super(1);
    ...
    public final Object invoke(Object[] objArr) {
        ...
        if (str != null) {
            ...
            NotificationChannel notificationChannel = access$getChannelManager$p.getNotificationChannel(str2);
