...
public final class NotificationChannelGroupManagerModule$definition$lambda$5$$inlined$AsyncFunction$5 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ NotificationChannelGroupManagerModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NotificationChannelGroupManagerModule$definition$lambda$5$$inlined$AsyncFunction$5(NotificationChannelGroupManagerModule notificationChannelGroupManagerModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        if (str != null) {
            ...
            NotificationChannelGroup createNotificationChannelGroup = access$getGroupManager$p.createNotificationChannelGroup(str2, this.this$0.getNameFromOptions(readableArguments), readableArguments);
            ...
            notificationsChannelGroupSerializer.toBundle(createNotificationChannelGroup);
            return;
        }
