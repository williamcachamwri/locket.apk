...
public final class NotificationChannelGroupManagerModule$definition$lambda$5$$inlined$AsyncFunction$8 extends Lambda implements Function1<Object[], Object> {
    final /* synthetic */ NotificationChannelGroupManagerModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NotificationChannelGroupManagerModule$definition$lambda$5$$inlined$AsyncFunction$8(NotificationChannelGroupManagerModule notificationChannelGroupManagerModule) {
        super(1);
    ...
    public final Object invoke(Object[] objArr) {
        ...
        if (str != null) {
            ...
            if (readableArguments != null) {
                ...
                NotificationChannelGroup createNotificationChannelGroup = access$getGroupManager$p.createNotificationChannelGroup(str2, this.this$0.getNameFromOptions(readableArguments2), readableArguments2);
                ...
                return notificationsChannelGroupSerializer.toBundle(createNotificationChannelGroup);
            }
