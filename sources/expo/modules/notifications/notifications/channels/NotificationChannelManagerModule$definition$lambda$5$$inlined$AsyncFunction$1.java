...
public final class NotificationChannelManagerModule$definition$lambda$5$$inlined$AsyncFunction$1 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ NotificationChannelManagerModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public NotificationChannelManagerModule$definition$lambda$5$$inlined$AsyncFunction$1(NotificationChannelManagerModule notificationChannelManagerModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        NotificationChannel notificationChannel = access$getChannelManager$p.getNotificationChannel(str);
