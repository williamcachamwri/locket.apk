...
final class ExpoNotificationPresentationModule$dismissAllNotificationsAsync$1 extends Lambda implements Function2<Integer, Bundle, Unit> {
    final /* synthetic */ Promise $promise;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ExpoNotificationPresentationModule$dismissAllNotificationsAsync$1(Promise promise) {
        super(2);
    ...
    public final void invoke(int i, Bundle bundle) {
        ...
        this.$promise.reject("ERR_NOTIFICATIONS_DISMISSAL_FAILED", "Notifications could not be dismissed.", exc);
    }
}
