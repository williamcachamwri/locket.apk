...
final class ExpoNotificationPresentationModule$dismissNotificationAsync$1 extends Lambda implements Function2<Integer, Bundle, Unit> {
    final /* synthetic */ Promise $promise;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ExpoNotificationPresentationModule$dismissNotificationAsync$1(Promise promise) {
        super(2);
    ...
    public final void invoke(int i, Bundle bundle) {
        ...
        this.$promise.reject("ERR_NOTIFICATION_DISMISSAL_FAILED", "Notification could not be dismissed.", exc);
    }
}
