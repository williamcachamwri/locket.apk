...
public final class ExpoNotificationCategoriesModule$definition$lambda$2$$inlined$AsyncFunction$17 extends Lambda implements Function1<Object[], Object> {
    final /* synthetic */ ExpoNotificationCategoriesModule $receiver$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ExpoNotificationCategoriesModule$definition$lambda$2$$inlined$AsyncFunction$17(ExpoNotificationCategoriesModule expoNotificationCategoriesModule) {
        super(1);
    ...
    public final Object invoke(Object[] objArr) {
        ...
        if (str != null) {
            ...
            if (promise != null) {
                this.$receiver$inlined.deleteNotificationCategoryAsync(str2, promise);
