...
public final class ExpoNotificationCategoriesModule$definition$lambda$2$$inlined$AsyncFunction$14 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ ExpoNotificationCategoriesModule $receiver$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ExpoNotificationCategoriesModule$definition$lambda$2$$inlined$AsyncFunction$14(ExpoNotificationCategoriesModule expoNotificationCategoriesModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        String str = objArr[0];
        if (str != null) {
            this.$receiver$inlined.deleteNotificationCategoryAsync(str, promise);
            return;
        }
