...
public final class BrightnessModule$definition$lambda$10$$inlined$AsyncFunction$12 extends Lambda implements Function1<Object[], Object> {
    final /* synthetic */ BrightnessModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BrightnessModule$definition$lambda$10$$inlined$AsyncFunction$12(BrightnessModule brightnessModule) {
        super(1);
    ...
    public final Object invoke(Object[] objArr) {
        ...
        if (f != null) {
            ...
            if (Settings.System.canWrite(this.this$0.getCurrentActivity())) {
                ...
                return Boolean.valueOf(Settings.System.putInt(this.this$0.getCurrentActivity().getContentResolver(), "screen_brightness", MathKt.roundToInt(floatValue * ((float) 255))));
            }
