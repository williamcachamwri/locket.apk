...
public final class BrightnessModule$definition$lambda$10$$inlined$AsyncFunction$14 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ BrightnessModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public BrightnessModule$definition$lambda$10$$inlined$AsyncFunction$14(BrightnessModule brightnessModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        if (Settings.System.canWrite(this.this$0.getCurrentActivity())) {
            Settings.System.putInt(this.this$0.getCurrentActivity().getContentResolver(), "screen_brightness_mode", this.this$0.brightnessModeJSToNative(intValue));
            return;
        }
