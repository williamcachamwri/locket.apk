...
public final class SplashScreenModule$definition$lambda$6$$inlined$AsyncFunction$6 extends Lambda implements Function1<Object[], Object> {
    ...
    public final Object invoke(Object[] objArr) {
        ...
        if (promise != null) {
            ...
            if (currentActivity != null) {
                SplashScreen.INSTANCE.hide(currentActivity, new SplashScreenModule$definition$1$2$1$1(promise2), new SplashScreenModule$definition$1$2$1$2(promise2));
                unit = Unit.INSTANCE;
            } else {
                unit = null;
            }
