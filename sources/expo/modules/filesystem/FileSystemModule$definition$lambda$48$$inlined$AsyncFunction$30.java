...
public final class FileSystemModule$definition$lambda$48$$inlined$AsyncFunction$30 extends Lambda implements Function2<Object[], Promise, Unit> {
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        if (str != null) {
            ...
            if (Intrinsics.areEqual((Object) parse.getScheme(), (Object) "file")) {
                ...
                if (intermediates ? access$toFile.mkdirs() : access$toFile.mkdir()) {
                    return;
                }
