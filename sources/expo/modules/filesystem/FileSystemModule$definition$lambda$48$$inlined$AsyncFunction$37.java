...
public final class FileSystemModule$definition$lambda$48$$inlined$AsyncFunction$37 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ FileSystemModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public FileSystemModule$definition$lambda$48$$inlined$AsyncFunction$37(FileSystemModule fileSystemModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        if (Intrinsics.areEqual((Object) parse.getScheme(), (Object) "file")) {
            this.this$0.contentUriFromFile(this.this$0.toFile(parse)).toString();
            return;
        }
