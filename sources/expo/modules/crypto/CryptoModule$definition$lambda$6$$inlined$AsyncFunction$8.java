...
public final class CryptoModule$definition$lambda$6$$inlined$AsyncFunction$8 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ CryptoModule $receiver$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CryptoModule$definition$lambda$6$$inlined$AsyncFunction$8(CryptoModule cryptoModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        String unused = this.$receiver$inlined.getRandomBase64String(((Integer) promise).intValue());
    }
