...
public final class CryptoModule$definition$lambda$6$$inlined$AsyncFunction$3 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ CryptoModule $receiver$inlined;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public CryptoModule$definition$lambda$6$$inlined$AsyncFunction$3(CryptoModule cryptoModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        if (digestAlgorithm != null) {
            ...
            String str = objArr[1];
            if (str != null) {
                String unused = this.$receiver$inlined.digestString(digestAlgorithm2, str, (DigestOptions) promise);
                return;
            }
