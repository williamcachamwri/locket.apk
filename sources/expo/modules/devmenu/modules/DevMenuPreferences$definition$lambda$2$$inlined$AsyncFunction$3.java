...
public final class DevMenuPreferences$definition$lambda$2$$inlined$AsyncFunction$3 extends Lambda implements Function1<Object[], Object> {
    final /* synthetic */ DevMenuPreferences this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DevMenuPreferences$definition$lambda$2$$inlined$AsyncFunction$3(DevMenuPreferences devMenuPreferences) {
        super(1);
    ...
    public final Object invoke(Object[] objArr) {
        ...
        ReadableMap readableMap = objArr[0];
        if (readableMap != null) {
            this.this$0.getPreferencesHandel().setPreferences(readableMap);
