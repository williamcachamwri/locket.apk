...
public final class DeviceModule$definition$lambda$8$$inlined$AsyncFunction$1 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ DeviceModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public DeviceModule$definition$lambda$8$$inlined$AsyncFunction$1(DeviceModule deviceModule) {
        super(2);
