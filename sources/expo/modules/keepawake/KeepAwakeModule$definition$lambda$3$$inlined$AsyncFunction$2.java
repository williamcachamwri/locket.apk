...
public final class KeepAwakeModule$definition$lambda$3$$inlined$AsyncFunction$2 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ KeepAwakeModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public KeepAwakeModule$definition$lambda$3$$inlined$AsyncFunction$2(KeepAwakeModule keepAwakeModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        if (str != null) {
            try {
                this.this$0.getKeepAwakeManager().activate(str, new KeepAwakeModule$definition$1$1$1(promise));
