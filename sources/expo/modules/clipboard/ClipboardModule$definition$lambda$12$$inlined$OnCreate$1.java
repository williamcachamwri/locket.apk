...
public final class ClipboardModule$definition$lambda$12$$inlined$OnCreate$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ ClipboardModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ClipboardModule$definition$lambda$12$$inlined$OnCreate$1(ClipboardModule clipboardModule) {
        super(0);
        this.this$0 = clipboardModule;
    }

    public final void invoke() {
        this.this$0.clipboardEventEmitter = new ClipboardModule.ClipboardEventEmitter();
        ...
        access$getClipboardEventEmitter$p.attachListener();
    }
}
