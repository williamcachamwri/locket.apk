    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            if (obj2 != null) {
                ...
                File access$getClipboardCacheDir = this.this$0.getClipboardCacheDir();
                this.label = 1;
                obj = ClipboardImageKt.clipDataFromBase64Image(access$getContext, str, access$getClipboardCacheDir, this);
            ...
            try {
                ...
                if (!(th instanceof CodedException)) {
                    th = new CopyFailureException(th, "image");
                }
                throw th;
            }
        } else {
