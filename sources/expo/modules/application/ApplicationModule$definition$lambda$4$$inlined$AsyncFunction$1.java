...
public final class ApplicationModule$definition$lambda$4$$inlined$AsyncFunction$1 extends Lambda implements Function2<Object[], Promise, Unit> {
    final /* synthetic */ ApplicationModule this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public ApplicationModule$definition$lambda$4$$inlined$AsyncFunction$1(ApplicationModule applicationModule) {
        super(2);
    ...
    public final void invoke(Object[] objArr, Promise promise) {
        ...
        InstallReferrerClient build = InstallReferrerClient.newBuilder(this.this$0.getContext()).build();
