...
public final class RequestService {
    ...
    private final boolean isConfigValidForHardwareAllocation(ImageRequest imageRequest, Size size) {
        ...
        if (!isConfigValidForHardware(imageRequest, imageRequest.getBitmapConfig()) || !this.hardwareBitmapService.allowHardwareMainThread(size)) {
            return false;
        }
        return true;
    }
